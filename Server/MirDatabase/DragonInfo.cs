...
namespace Server.MirDatabase
{
    public class DragonInfo
    {
        ...
        public DragonInfo()
        {
            ...
            DeLevelDelay = Settings.Minute * 60;
        }
        public DragonInfo(BinaryReader reader, int version)
        {
