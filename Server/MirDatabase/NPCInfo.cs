...
namespace Server.MirDatabase
{
    public class NPCInfo
    {
        ...
        public NPCInfo(BinaryReader reader)
        {
            ...
            if (Envir.LoadVersion > 141)
                SWOverRide = reader.ReadBoolean();
        }
        ...
        public static void FromText(string text)
        {
            ...
            if (!int.TryParse(data[2], out int x)) return;
            if (!int.TryParse(data[3], out int y)) return;
