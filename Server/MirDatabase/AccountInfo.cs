    ...
    public class AccountInfo
    {
        ...
        public AccountInfo(BinaryReader reader)
        {
            ...
            if (Envir.LoadVersion > 86)
                DevAccount = reader.ReadBoolean();

            if (Envir.LoadVersion > 118)
                ChatBanned = reader.ReadBoolean();
        }
        ...
        public ListViewItem CreateListView()
        {
            ...
            ListItem.SubItems.Add(DevAccount.ToString());
        ...
        public void Update()
        {
            ...
            ListItem.SubItems[8].Text = DevAccount.ToString();
        }
