...
namespace Server
{
    public partial class HeroQuestInfoForm : Form
    {
        ...
        private void UpdateInterface()
        {
            if (QuestInfoListBox.Items.Count != Envir.QuestInfoList.Count(x => x.HeroQuest))
            {
                ...
                RequiredQuestComboBox.Items.Add(new QuestInfo(true) { Index = 0, Name = "None" });
        ...
        public void ExportQuests(List<QuestInfo> Quests)
        {
            ...
            {
                InitialDirectory = Application.StartupPath + @"\Exports",
