        ...
        private void SpawnSlaves()
        {
            ...
            for (int i = 0; i < count; i++)
            {
                ...
                if (Info.Name.Contains("Ancient"))
                {
                    ...
                    {
                        case 0:
                            mob = GetMonster(Envir.GetMonsterInfo(Settings.AncZuma1));
                            break;
                        case 1:
                            mob = GetMonster(Envir.GetMonsterInfo(Settings.AncZuma2));
                            break;
                        case 2:
                            mob = GetMonster(Envir.GetMonsterInfo(Settings.AncZuma3));
                            break;
                        case 3:
                            mob = GetMonster(Envir.GetMonsterInfo(Settings.AncZuma4));
                            break;
                        case 4:
                            mob = GetMonster(Envir.GetMonsterInfo(Settings.AncZuma5));
                            break;
                        case 5:
                            mob = GetMonster(Envir.GetMonsterInfo(Settings.AncZuma6));
                            break;
                        case 6:
                            mob = GetMonster(Envir.GetMonsterInfo(Settings.AncZuma7));
                            break;
                    }
                }
                else
