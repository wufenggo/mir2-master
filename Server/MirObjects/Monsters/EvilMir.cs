...
namespace Server.MirObjects.Monsters
{
    class EvilMir : MonsterObject
    {
        ...
        {
            //  it sleeps, doesn't die so it'll always be there
        ...
        protected override void ProcessTarget()
        {
            ...
            if (DragonLink)
            {
                ...
                else//  6 * Delevel(Minutes) when it reaches max level 2 * 60 2-R/s
                    Envir.DragonSystem.DeLevelTime = Envir.Time + (2 * Envir.DragonSystem.DeLevelDelay);
            }
