...
namespace Server.MirObjects.Monsters
{
    class SandSnail : MonsterObject
    {
        ...
        public void AttackAOE()
        {
            ...
            {
                targets[i].ApplyPoison(new Poison { PType = PoisonType.Green, Duration = 6 + Envir.Random.Next(4),Value = GetAttackPower(MinSC, MaxSC), TickSpeed = 1000 }, this, true);
            }
