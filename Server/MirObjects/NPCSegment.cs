...
namespace Server.MirObjects
{
    public class NPCSegment
    {
        ...
        public int WindowImage,helpX,helpY,exitX,exitY,questX,questY;

        public NPCSegment(NPCPage page, List<string> say, List<string> buttons, List<string> elseSay, List<string> elseButtons, List<string> gotoButtons, int sayType = -1)
        {
            Page = page;
        ...
        public void ParseCheck(string line)
        {
            ...
            switch (parts[0].ToUpper())
            {
                ...
                case "CHECKVIP":
                    ...
                    CheckList.Add(new NPCChecks(CheckType.CheckVIP));
                    break;
                ...
                case "CHECKHEROALIVE":
                    ...
                    CheckList.Add(new NPCChecks(CheckType.CheckHeroAlive));
                    break;
                ...
                case "CANREMOVEHERO":
                    ...
                    CheckList.Add(new NPCChecks(CheckType.CanRemoveHero));
                    break;
                ...
                case "CHECKHUMUP":
                    ...
                    CheckList.Add(new NPCChecks(CheckType.CheckHumUp));
                    break;
                ...
                case "CHECKGROUPRANGE":
                    if (parts.Length < 4) return;

                    CheckList.Add(new NPCChecks(CheckType.CheckGroupRange, parts[1], parts[2], parts[3]));
                    break;
                ...
                case "CONQUESTOWNER":
                    ...
                    break;
                case "CHECKUPGRADESHIELD":
                    CheckList.Add(new NPCChecks(CheckType.CheckCanUpgradeShield));
                    break;
                case "CHECKLMS":
                    if (parts.Length < 2) return;
                    //  STARTLMS MapName X Y Size Duration
                    CheckList.Add(new NPCChecks(CheckType.CheckLMSStatus, parts[1]));
                    break;
            }
        ...
        public void ParseAct(List<NPCActions> acts, string line)
        {
            ...
            switch (parts[0].ToUpper())
            {
                ...
                case "GIVEVIP":
                    ...
                    acts.Add(new NPCActions(ActionType.GiveVip, parts[1]));
                    break;
                case "TOWNTELEPORT":
                    acts.Add(new NPCActions(ActionType.TownTeleport));
                    break;
                case "BUYGT":
                    if (parts.Length < 1)
                    {
                ...
                case "SETHUMUP":
                    ...
                    acts.Add(new NPCActions(ActionType.GiveHumup, parts[1]));
                    break;

                case "AUTOPOT":
                    acts.Add(new NPCActions(ActionType.AutoPot));
                    break;
                ...
                case "SETNAMECOLOR":
                    ...
                    acts.Add(new NPCActions(ActionType.SetNameColor, parts[1]));
                    break;

                case "REMOVEHERO":
                    acts.Add(new NPCActions(ActionType.RemoveHero));
                    break;
                ...
                case "DISBANDGUILD":
                    acts.Add(new NPCActions(ActionType.DisbandGuild));
                    break;
                ...
                case "UPGRADESHIELD":
                    if (parts.Length < 2)
                        return;
                    acts.Add(new NPCActions(ActionType.UpgradeShield, parts[1]));
                    break;
                case "SPAWNMONSTER":
                    if (parts.Length < 2)
                        return;
                    if (parts.Length > 3)
                        acts.Add(new NPCActions(ActionType.SpawnMonster, parts[1], parts[2], parts[3]));
                    else
                        acts.Add(new NPCActions(ActionType.SpawnMonster, parts[1], parts[2]));
                    break;
                case "REALIVEHERO":
                    acts.Add(new NPCActions(ActionType.RealiveHero));
                    break;
                case "STARTLMS":
                    if (parts.Length < 6)
                        return;
                    acts.Add(new NPCActions(ActionType.StartLMS, parts[1], parts[2], parts[3], parts[4], parts[5]));
                    break;
            }
        ...
        public string ReplaceValue(PlayerObject player, string param)
        {
            ...
            switch (innerMatch)
            {
                ...
                case "TORCH":
                    ...
                    break;
                case "POISON": //New slot by Ice
                    newValue = player.Info.Equipment[(int)EquipmentSlot.Poison] != null ?
                        player.Info.Equipment[(int)EquipmentSlot.Poison].Info.Name : "No Poison";
                    break;
                case "MEDALS": // New slot by Ice
                    newValue = player.Info.Equipment[(int)EquipmentSlot.Medals] != null ?
                        player.Info.Equipment[(int)EquipmentSlot.Medals].Info.Name : "No Metal";
                    break;
                case "SHIELD": // New slot by Ice
                    ...
                    break;
                case "PADS": // New slot by Ice
                    newValue = player.Info.Equipment[(int)EquipmentSlot.Pads] != null ?
                        player.Info.Equipment[(int)EquipmentSlot.Pads].Info.Name : "No Pads";
                    break;
                case "TROPHY": // New slot by Ice
                    newValue = player.Info.Equipment[(int)EquipmentSlot.Trophy] != null ?
                        player.Info.Equipment[(int)EquipmentSlot.Trophy].Info.Name : "No Trophy";
                    break;
                ...
                case "PARCELAMOUNT":
                    ...
                    break;
                case "SHIELDLEVEL":
                    if (player.Info.Equipment[(int)EquipmentSlot.Shield] != null)
                    {
                        newValue = player.Info.Equipment[(int)EquipmentSlot.Shield].ShieldLevel.ToString();
                        break;
                    }
                    else
                    {
                ...
                case "SHIELDEXP":
                    if (player.Info.Equipment[(int)EquipmentSlot.Shield] != null)
                    {
                        newValue = player.Info.Equipment[(int)EquipmentSlot.Shield].ShieldExp.ToString();
                        break;
                    }
                    else
                    {
                ...
                case "COMPLETEDQUESTS":
                    if (player.CompletedQuests != null)
                        newValue = string.Format("{0}", player.CompletedQuests.Count);                    
                    break;
                default:
            ...
            for (int i = 0; i < CheckList.Count; i++)
            {
                ...
                switch (check.Type)
                {
                    ...
                    case CheckType.CheckHum:
                        ...
                        int pCount = 0;
                        for (int x = 0; x < map.Players.Count; x++)
                        {
                            if (map.Players[x].Dead)
                                continue;
                            pCount++;
                        }
                        failed = !Compare(param[0], pCount, tempInt);
            ...
            for (int i = 0; i < CheckList.Count; i++)
            {
                ...
                switch (check.Type)
                {
                    ...
                    case CheckType.Check:
                        ...
                        if (Monster != null && Monster.EXPOwner != null &&
                            Monster.EXPOwner.Race == ObjectType.Player)
                            player = (PlayerObject)Monster.EXPOwner;
                        if (player != null)
                        {
        ...
        public bool Check(PlayerObject player)
        {
            ...
            for (int i = 0; i < CheckList.Count; i++)
            {
                ...
                switch (check.Type)
                {
                    ...
                    case CheckType.CheckVIP:

                        if (player.VIP <= DateTime.Now) failed = true;
                        else
                            failed = false;

                        break;

                    case CheckType.HasGT:

                        if (player.MyGuild == null) failed = true;
                        else
                        {
                            if (player.MyGuild.GTRent == null)
                                failed = true;
                            else
                                failed = player.MyGuild.HasGT;
                        }
                        break;
                    ...
                    case CheckType.HasHero:
                        ...
                        if (player.GainedHero && player.Hero!= null) failed = false;
                        else
                            failed = true;

                        break;

                    case CheckType.CheckHeroAlive:

                        failed = false;
                        if (!player.GainedHero) failed = true;
                        if (player.Hero == null) failed = true;
                        if (player.Hero.Dead) failed = true;

                        break;


                    case CheckType.CheckHumUp:

                        if (!player.HumUp) failed = true;
                        else
                            failed = false;

                        break;

                    case CheckType.CanRemoveHero:
                        failed = false;
                        ...
                        foreach (var v in player.Hero.Equipment)
                        {
                            if (v != null)
                            { failed = true;
                                break;
                        ...
                        foreach (var v in player.Hero.Inventory)
                        {
                            if (v != null)
                            {
                                failed = true;
                    ...
                    case CheckType.CheckHeroClass:
                        ...
                        if (player.Hero == null || !player.Hero.isSpawn)
                        {
                            failed = true;
                            break;
                        }
                        ...
                        failed = player.Hero.HeroClass != mirClass;
                        break;
                    ...
                    case CheckType.CheckGroupRange:
                        {
                            if (!int.TryParse(param[0], out x) || !int.TryParse(param[1], out y) || !int.TryParse(param[2], out range))
                            {
                                failed = true;
                            ...
                            failed = false;
                            for (int o = 0; o < player.GroupMembers.Count; o++)
                            {
                                if (player.GroupMembers[o].CurrentMap == 
                                    player.CurrentMap)
                                {
                                    if (!Functions.InRange(target, player.GroupMembers[o].CurrentLocation, range))
                                    {
                                        failed = true;
                                        break;
                                    }
                    ...
                    case CheckType.IsGuildLeader:
                        ...
                        if (param[0].Length > 0 && player.MyGuild.Name != param[0])
                        {
                            failed = true;
                            break;
                        }

                        if (player.MyGuildRank == null )
                        {
                            failed = true;
                            break;
                        }
                    ...
                    case CheckType.InNewbieGuild:
                        failed = player.MyGuild == null || player.MyGuild.Name != Settings.NewbieName;
                        break;
                    ...
                    case CheckType.ConquestOwner:
                        ...
                        break;
                    case CheckType.CheckCanUpgradeShield:
                        if (player.Info.Equipment[(int)EquipmentSlot.Shield] != null)
                        {
                            if (!player.CanUpgradeShield())
                                failed = true;
                        }
                        else
                            failed = true;
        ...
        private void Act(IList<NPCActions> acts, PlayerObject player)
        {
            ...
            for (var i = 0; i < acts.Count; i++)
            {
                ...
                switch (act.Type)
                {
                    ...
                    case ActionType.GiveVip:
                        if (!uint.TryParse(param[0], out count)) return;


                        if (count > 0)
                        {
                            player.VIP = DateTime.Now.AddDays(count);
                            player.ReceiveChat(string.Format("You are now VIP untill : {0} ", player.VIP), ChatType.System);
                        }
                        else
                        {
                            player.VIP = DateTime.MinValue;
                            player.ReceiveChat(string.Format("You are no longer VIP"), ChatType.System);
                        }

                        player.SetLevelEffects();

                        player.CurrentMap.Broadcast(new S.SetVIP { VIP = player.VIP, ObjectID = player.ObjectID }, player.CurrentLocation);
                    ...
                    case ActionType.BuyGT:
                        ...
                        {
                            player.ReceiveChat("You already own a GT!", ChatType.System);
                            return;
                        }

                        GTMap GTmap = null;
                        foreach (var gt in SMain.Envir.GTMapList)
                        {
                            if (gt.Owner == "None")
                            {
                                GTmap = gt;
                        ...
                        if (GTmap == null)
                        {
                            player.ReceiveChat("No GT's available!", ChatType.System);
                            return;
                        }
                    ...
                    case ActionType.TeleportGT:
                        ...
                        if (!player.MyGuild.HasGT)
                        {
                            player.ReceiveChat("You dont own a GT!", ChatType.System);
                            return;
                        }
                        ...
                        map = SMain.Envir.GetMap(GTmap.index);
                    ...
                    case ActionType.GiveHumup:
                        bool value2;
                        if (!bool.TryParse(param[0], out value2)) return;

                        player.SetHumUp(value2);

                        break;

                    case ActionType.AutoPot:

                        if (player.Hero != null && player.Hero.isSpawn)
                        {
                            player.Hero.autoPotSystem.AllowAutoPot();
                            player.Enqueue(new S.SetAutoPot { AutoPot = player.Hero.autoPotSystem.isEnabled });
                        }
                        else
                        {
                            player.ReceiveChat("Hero must be spawned!", ChatType.System);
                        }

                        break;

                    case ActionType.SetNameColor:
                        player.TempColour = Color.FromName(param[0]);
                        player.RefreshNameColour();

                        break;

                    case ActionType.RemoveHero:
                        if (player.Hero != null )
                        {
                            if (player.Hero.isSpawn)
                            {
                                SMain.Envir.MonsterCount--;
                                player.Hero.CurrentMap.MonsterCount--;
                                player.Hero.CurrentMap.RemoveObject(player.Hero);
                                player.Hero.Despawn();
                            }

                            player.Hero.Deleted = true;
                            player.Hero.Active = false;

                            if (player.HeroList.Count(o => !o.Deleted) == 0)
                            {
                                player.GainedHero = false;
                                var pack = new S.SetHero { setHero = player.GainedHero };
                                player.Enqueue(pack);
                            }

                           // player.CompletedQuests.RemoveAll(x1 => SMain.Envir.QuestInfoList.Any(y1 => y1.Index == x1 && y1.HeroQuest));
                    ...
                    case ActionType.DisbandGuild:
                        if (player.MyGuild == null)
                        {
                            player.ReceiveChat(string.Format("You do not have a guild"), ChatType.System);
                            return;
                        }

                        if (player.MyGuild.Membercount > 1)
                        {
                            player.ReceiveChat(string.Format("Guild needs to have 1 member left in order to be disbanded"), ChatType.System);
                            return;
                        }

                        if (player.MyGuild.Name == Settings.NewbieName)
                        {
                            player.ReceiveChat(string.Format("NewbieGuild can not be deleted"), ChatType.System);
                            return;
                        }

                        SMain.Envir.GuildList.Remove(player.MyGuild);

                        player.Info.GuildIndex = -1;
                        player.MyGuild = null;
                        player.MyGuildRank = null;
                        player.ReceiveChat("Guild has been disbanded", ChatType.Guild);
                        player.Enqueue(new S.GuildStatus() { GuildName = "", GuildRankName = "", MyOptions = (RankOptions)0 });
                    ...
                    case ActionType.GlobalMessage:
                        if (!Enum.TryParse(param[1], true, out chatType)) return;
                        string a_Buf = "";
                        string origString = param[0];
                        {
                            string regExpresh = @"\(([^)]*)\)";
                            string regExpreh0 = @"\[(.*?)\]";
                            Regex re = new Regex(regExpresh);
                            string[] temp_str = new string[5];
                            int lastInsert = 0;
                            foreach (Match m in re.Matches(param[0]))
                            {
                                if (lastInsert > 4)
                                    continue;
                                temp_str[lastInsert] = m.Value.Replace("(", "").Replace(")", "");
                                lastInsert++;
                            }
                            string[] temps_str = new string[5];
                            lastInsert = 0;
                            re = new Regex(regExpreh0);
                            foreach (string s in temp_str)
                            {
                                if (s == null)
                                    continue;
                                if (s.Contains("$CONQUESTOWNER"))
                                {
                                    foreach (Match m in re.Matches(s))
                                    {
                                        if (m == null)
                                            continue;
                                        temps_str[lastInsert] = m.Value.Replace("[", "").Replace("]", "");
                                        if (int.TryParse(temps_str[lastInsert], out tempInt))
                                        {
                                            Conquest = SMain.Envir.Conquests.FirstOrDefault(b => b.Info.Index == tempInt);
                                            if (Conquest != null && Conquest.Guild != null)
                                                a_Buf = Conquest.Guild.Name;
                                            if (a_Buf.Length <= 0)
                                                origString = origString.Replace(string.Format("($CONQUESTOWNER[{0}])", tempInt), "NONE");
                                            else
                                                origString = origString.Replace(string.Format("($CONQUESTOWNER[{0}])", tempInt), a_Buf);
                                        }
                                        else
                                        {
                                            a_Buf = "";
                                ...
                                if (s.Contains("$CONQUESTRATE"))
                                {
                                    foreach (Match m in re.Matches(s))
                                    {
                                        ...
                                        {
                                            Conquest = SMain.Envir.Conquests.FirstOrDefault(b => b.Info.Index == tempInt);
                                            if (Conquest != null && Conquest.npcRate >= 0)
                                                a_Buf = string.Format("{0}", Conquest.npcRate.ToString());
                                            if (a_Buf.Length <= 0)
                                                origString = origString.Replace(string.Format("($CONQUESTRATE[{0}])", tempInt), "NONE");
                                            else
                                                origString = origString.Replace(string.Format("($CONQUESTRATE[{0}])", tempInt), a_Buf + "%");
                                        }
                    ...
                    case ActionType.HeroGiveSkill:
                        ...
                        if (!Enum.TryParse(param[0], true, out skill)) return;
                        if (player.Hero == null || !player.Hero.isSpawn) return;

                        if (player.Hero.Magics.Any(e => e.Spell == skill)) break;

                        if (param.Count > 1)
                            spellLevel = byte.TryParse(param[1], out spellLevel) ? Math.Min((byte)3, spellLevel) : (byte)0;

                        magic = new UserMagic(skill) { Level = spellLevel };

                        if (magic.Info == null) return;

                        player.Hero.Magics.Add(magic);
                        player.Enqueue(magic.GetHeroInfo());
                        break;
                    ...
                    case ActionType.RemoveSkill:
                        ...
                        for (var j = player.Info.Magics.Count - 1; j >= 0; j--)
                        {
                            ...
                            player.Enqueue(new S.RemoveMagic { PlaceId = j, Hero = false });
                        }
                    ...
                    case ActionType.HeroRemoveSkill:
                        ...
                        for (var j = player.Hero.Magics.Count - 1; j >= 0; j--)
                        {
                            if (player.Hero.Magics[j].Spell != skill) continue;

                            player.Hero.Magics.RemoveAt(j);
                            player.Enqueue(new S.RemoveMagic { PlaceId = j, Hero = true });
                        }
                    ...
                    case ActionType.GiveHeroBuff:
                        {
                            ...
                            player.Hero.AddBuff(buff);
                            break;
                        }
                    case ActionType.RemoveHeroBuff:
                        {
                            if (!Enum.IsDefined(typeof(BuffType), param[0])) return;

                            BuffType bType = (BuffType)(byte)Enum.Parse(typeof(BuffType), param[0]);

                            for (int j = 0; j < player.Hero.Buffs.Count; j++)
                            {
                                if (player.Hero.Buffs[j].Type != bType) continue;

                                player.Hero.Buffs[j].Infinite = false;
                                player.Hero.Buffs[j].ExpireTime = SMain.Envir.Time;
                            }
                            break;
                        }
                    case ActionType.SetQuest:
                        {
                            ...
                            int.TryParse(param[0], out int questid);
                            int.TryParse(param[1], out int questState);
                            ...
                            player.GetClientCompletedQuests();
                        }
                        break;
                    case ActionType.GiveBuff:
                        {
                            ...
                            if (param[4].Length > 0)
                                bool.TryParse(param[4], out tempBool2);
                            if ((BuffType)(byte)Enum.Parse(typeof(BuffType), param[0], true) == BuffType.SwBuff)
                            {
                                int minACVal = 0, maxACVal = 0;
                                int minMACVal = 0, maxMACVal = 0;
                                int minDCVal = 0, maxDCVal = 0;
                                int minMCVal = 0, maxMCVal = 0;
                                int minSCVal = 0, maxSCVal = 0;
                                int AccVal = 0, AgilVal = 0;
                                int hpVal = 0, mpVal = 0;
                                int speedVal = 0;
                                switch (Settings.SWBuffInfo.Type)
                                {
                                    case 0:
                                        {
                                            minACVal = Settings.SWBuffInfo.BuffInfo[(int)player.Class].MinAC;
                                            maxACVal = Settings.SWBuffInfo.BuffInfo[(int)player.Class].MaxAC;
                                            minMACVal = Settings.SWBuffInfo.BuffInfo[(int)player.Class].MinMAC;
                                            maxMACVal = Settings.SWBuffInfo.BuffInfo[(int)player.Class].MaxMAC;
                                            minDCVal = Settings.SWBuffInfo.BuffInfo[(int)player.Class].MinDC;
                                            maxDCVal = Settings.SWBuffInfo.BuffInfo[(int)player.Class].MaxDC;
                                            minMCVal = Settings.SWBuffInfo.BuffInfo[(int)player.Class].MinMC;
                                            maxMCVal = Settings.SWBuffInfo.BuffInfo[(int)player.Class].MaxMC;
                                            minSCVal = Settings.SWBuffInfo.BuffInfo[(int)player.Class].MinSC;
                                            maxSCVal = Settings.SWBuffInfo.BuffInfo[(int)player.Class].MaxSC;
                                            AgilVal = Settings.SWBuffInfo.BuffInfo[(int)player.Class].Agility;
                                            AccVal = Settings.SWBuffInfo.BuffInfo[(int)player.Class].Accuracy;
                                            hpVal = Settings.SWBuffInfo.BuffInfo[(int)player.Class].HP;
                                            mpVal = Settings.SWBuffInfo.BuffInfo[(int)player.Class].MP;
                                            speedVal = Settings.SWBuffInfo.BuffInfo[(int)player.Class].ASpeed;
                                        }
                                        break;
                                    case 1:
                                        {
                                            minACVal = Math.Min(ushort.MaxValue, player.MinAC * Settings.SWBuffInfo.BuffInfo[(int)player.Class].MinAC / 100);
                                            maxACVal = Math.Min(ushort.MaxValue, player.MaxAC * Settings.SWBuffInfo.BuffInfo[(int)player.Class].MaxAC / 100);
                                            minMACVal = Math.Min(ushort.MaxValue, player.MinMAC * Settings.SWBuffInfo.BuffInfo[(int)player.Class].MinMAC / 100);
                                            maxMACVal = Math.Min(ushort.MaxValue, player.MaxMAC * Settings.SWBuffInfo.BuffInfo[(int)player.Class].MaxMAC / 100);
                                            minDCVal = Math.Min(ushort.MaxValue, player.MinDC * Settings.SWBuffInfo.BuffInfo[(int)player.Class].MinDC / 100);
                                            maxDCVal = Math.Min(ushort.MaxValue, player.MaxDC * Settings.SWBuffInfo.BuffInfo[(int)player.Class].MaxDC / 100);
                                            minMCVal = Math.Min(ushort.MaxValue, player.MinMC * Settings.SWBuffInfo.BuffInfo[(int)player.Class].MinMC / 100);
                                            maxMCVal = Math.Min(ushort.MaxValue, player.MaxMC * Settings.SWBuffInfo.BuffInfo[(int)player.Class].MaxMC / 100);
                                            minSCVal = Math.Min(ushort.MaxValue, player.MinSC * Settings.SWBuffInfo.BuffInfo[(int)player.Class].MinSC / 100);
                                            maxSCVal = Math.Min(ushort.MaxValue, player.MaxSC * Settings.SWBuffInfo.BuffInfo[(int)player.Class].MaxSC / 100);
                                            AgilVal = Math.Min(ushort.MaxValue, player.Agility * Settings.SWBuffInfo.BuffInfo[(int)player.Class].Agility / 100);
                                            AccVal = Math.Min(ushort.MaxValue, player.Accuracy * Settings.SWBuffInfo.BuffInfo[(int)player.Class].Accuracy / 100);
                                            hpVal = Math.Min(ushort.MaxValue, player.Info.HP * Settings.SWBuffInfo.BuffInfo[(int)player.Class].HP / 100);
                                            mpVal = Math.Min(ushort.MaxValue, player.MP * Settings.SWBuffInfo.BuffInfo[(int)player.Class].MP / 100);
                                            speedVal = Math.Min(ushort.MaxValue, player.ASpeed * Settings.SWBuffInfo.BuffInfo[(int)player.Class].ASpeed / 100);
                                        }
                                        break;
                                }
                                intValues = new int[]
                                {
                                    Settings.SWBuffInfo.EXPBoost,//0
                                    Settings.SWBuffInfo.DropBoost,//1
                                    minACVal, maxACVal,//2,3
                                    minMACVal, maxMACVal,//4,5
                                    minDCVal, maxDCVal,//6,7
                                    minMCVal, maxMCVal,//8,9
                                    minSCVal, maxSCVal,//10,11
                                    AccVal, AgilVal,//12,13
                                    hpVal, mpVal,//14,15
                                    speedVal//16
                                };
                            }
                    ...
                    case ActionType.RefreshEffects:
                        ...
                        player.Broadcast(p);
                        break;
                    case ActionType.TownTeleport:
                        if (player.BindMapIndex != -1)
                        {
                            map = SMain.Envir.GetMap(player.BindMapIndex);
                            if (map != null)
                                player.Teleport(map, player.BindLocation, true);
                        }
                        break;
                    ...
                    case ActionType.AddToNewbieGuild:
                        {
                            ...
                            if (player.Level > Settings.NewbieMaxLevel)
                            {
                                player.ReceiveChat("Your level is above limit!", ChatType.System);
                                return;
                            }

                            if (player.PKPoints >= 200)
                            {
                                player.ReceiveChat("Your to evil for help!", ChatType.System);
                                return;
                            }

                            GuildObject guild = SMain.Envir.GetGuild(Settings.NewbieName);

                            if (guild == null)
                                player.CreateNewbieGuild(Settings.NewbieName);

                            guild = SMain.Envir.GetGuild(Settings.NewbieName);
                            player.PendingGuildInvite = guild;
                            player.GuildInvite(true);
                        }
                        break;
                    ...
                    case ActionType.CloseGate:
                        ...
                        break;
                    case ActionType.UpgradeShield:
                        if (!int.TryParse(param[0], out tempInt))
                        {
                            return;
                        }
                        player.UpgradeShield(tempInt, true);
                        break;
                }
            }
        }
            ...
            for (var i = 0; i < acts.Count; i++)
            {
                ...
                switch (act.Type)
                {
                    ...
                    case ActionType.SpawnMonster:
                        ...
                        {
                            MonsterInfo mob = new MonsterInfo();
                            mob = SMain.Envir.GetMonsterInfo(param[0]);
                            int count = Convert.ToInt32(param[1]);
                            MonsterObject monster = MonsterObject.GetMonster(mob);
                            monster.Spawn(Monster.CurrentMap, Monster.CurrentLocation);
                        }
                        break;
                    case ActionType.Set:
                        if (Monster != null &&
                            ...
                            Monster.EXPOwner.Race == ObjectType.Player)
                        {
                            PlayerObject player = (PlayerObject)Monster.EXPOwner;
                            if (!int.TryParse(param[0], out int flagIndex))
                                return;
                            if (!uint.TryParse(param[1], out uint onCheck))
                                return;
        ...
        {
            if (!Monster.hasDieScriptTriggered)
                Act(ActList, Monster);
        }
