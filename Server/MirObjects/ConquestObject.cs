...
namespace Server.MirObjects
{
    public class ConquestObject
    {
        ...
        public void AutoSchedule()
        {
            ...
            if (CheckDay())
            {
                ...
                if (AttackerID != -1)
                {
                    ...
                    {
                        Envir.Broadcast(new S.Chat { Message = string.Format("{0} war will start in 1 hour!", Info.Name), Type = ChatType.System });
                        hasAnnounce = true;
                    }
                    if (now == 1081)
                        hasAnnounce = false;
                    ...
                    {
                        Envir.Broadcast(new S.Chat { Message = string.Format("{0} war will start in 30 minutes!", Info.Name), Type = ChatType.System });
                        hasAnnounce = true;
                    }
                    if (now == 1111)
                        hasAnnounce = false;
                    ...
                    {
                        Envir.Broadcast(new S.Chat { Message = string.Format("{0} war will start in 10 minutes!", Info.Name), Type = ChatType.System });
                        hasAnnounce = true;
                    }
                    if (now == 1131)
                        hasAnnounce = false;
                    ...
                    {
                        Envir.Broadcast(new S.Chat { Message = string.Format("{0} war will end in 10 minutes!", Info.Name), Type = ChatType.System });
                        hasAnnounce = true;
                    }
                    if (now == 1161)
                        hasAnnounce = false;
            ...
            if (StartType != ConquestType.Forced)
            {
                if (WarIsOn && now == 1170)
                {
                    ...
                    if (Guild != null && Guild.Name != null &&
                        ...
                        {
                            Envir.Broadcast(new S.Chat { Message = string.Format("{0} war has ended! The winning guild {1} now occupy {0}!", Info.Name, Guild.Name), Type = ChatType.System });
                            hasAnnounce = true;
                        }
                }
        ...
        public void TakeConquest(PlayerObject player = null, GuildObject winningGuild = null)
        {
            ...
            switch (GameType)
            {
                ...
                case ConquestGame.Classic:
                    ...
                    Guild = winningGuild;
                    Guild.Conquest = this;
                    if (Guild != null && (Guild.Name != "" || Guild.Name != null))
                        Envir.Broadcast(new S.Chat { Message = string.Format("{0} guild are now occupying {1}!", Guild.Name, Info.Name), Type = ChatType.System });
                    break;
        ...
        {
            WarIsOn = true;
            Envir.Broadcast(new S.Chat { Message = string.Format("{0} War has started!", Info.Name), Type = ChatType.System });
        }
