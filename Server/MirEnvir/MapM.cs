                                    ...
                                    switch (target.Race)
                                    {
                                        ...
                                        case ObjectType.Hero:
                                            if (target.IsAttackTarget(mob))
                                            {
                                                ...
                                                {
                                                    if (mob.Level + (target.Race == ObjectType.Player ? 2 : 10) >= target.Level && Envir.Random.Next(target.Race == ObjectType.Player ? 100 : 20) <= magicLevel)
                                                    {
                                                    ...
                                                    if (mob.Level + (target.Race == ObjectType.Player ? 2 : 10) >= target.Level && Envir.Random.Next(target.Race == ObjectType.Player ? 100 : 40) <= magicLevel)
                                                    {
                                                        target.ApplyPoison(new Poison
                                                        {
                                                            Owner = mob,
                ...
                case Spell.MoonMist:
                    ...
                    for (int y = location.Y - 2; y <= location.Y + 2; y++)
                    {
                        ...
                        for (int x = location.X - 2; x <= location.X + 2; x++)
                        {
                            ...
                            List<MapObject> RepulsePlayers = new List<MapObject>();
                            ...
                            for (int i = 0; i < cell.Objects.Count; i++)
                            {
                                ...
                                switch (target.Race)
                                {
                                    ...
                                    case ObjectType.Player:
                                        ...
                                        if (target.Attacked(player, value, DefenceType.ACAgility, false) <= 0) break;
                                ...
                                switch (target.Race)
                                {
                                    ...
                                    case ObjectType.Hero:
                                        ...
                                        if (target.Attacked(player, value, DefenceType.AC, false) > 0)
                                        {
                                            ...
                                            target.ApplyPoison(new Poison { PType = PoisonType.Bleeding, Duration = magic.Level + 2, TickSpeed = 1000 }, player);
                                ...
                                switch (target.Race)
                                {
                                    ...
                                    case ObjectType.Hero:
                                        ...
                                        if (target.Attacked(player, value, DefenceType.MAC, false) > 0)
                                        {
                                            ...
                                            target.ApplyPoison(new Poison { PType = PoisonType.Slow, Duration = magic.Level + 2, TickSpeed = 1000 }, player);
                            ...
                            for (int i = 0; i < cell.Objects.Count; i++)
                            {
                                ...
                                switch (target.Race)
                                {
                                    ...
                                    case ObjectType.Hero:
                                        ...
                                        {
                                            //nope :P
                                           // if (target.Undead)O.o why?  when did ts give a stun poison lolit wasnt a poison orig, the mobs always got stun locked with 2 wizz tsing  this is svn code lol
                                         //   {
                                ...
                                for (int k = 0; k < cell.Objects.Count; k++)
                                {
                                    ...
                                    switch (target.Race)
                                    {
                                        ...
                                        case ObjectType.Hero:
                                            ...
                                            {
                                                //Only targets
                                                if (target.Attacked(player,farDamage, DefenceType.MAC, false) > 0)
                                                {
                                    ...
                                    case ObjectType.Hero:
                                        ...
                                        if (target.IsAttackTarget(player))
                                        {
                                            ...
                                            if(x == location.X && y == location.Y)
                                                target.Attacked(player, player.MaxSC, DefenceType.MAC, false);
