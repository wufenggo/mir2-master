...
namespace Server.MirEnvir
{
    ...
    public class Envir
    {
        ...
        private void FillMagicInfoList()
        {
            ...
            if (!MagicExists(Spell.Blink)) MagicInfoList.Add(new MagicInfo { Name = "移形换位", Spell = Spell.Blink, Icon = 20, Level1 = 19, Level2 = 22, Level3 = 25, Need1 = 350, Need2 = 1000, Need3 = 2000, BaseCost = 10, LevelCost = 3, Range = 9 });
           ...
           // if (!MagicExists(Spell.HealingCircle)) MagicInfoList.Add(new MagicInfo { Name = "阴阳五行阵 ", Spell = Spell.HealingCircle, Icon = 86, Level1 = 60, Level2 = 61, Level3 = 61, Need1 = 4400, Need2 = 7400, Need3 = 1170, BaseCost = 30, LevelCost = 40, DelayBase = 50, DelayReduction = 2000, Range = 9 });
            ...
            if (!MagicExists(Spell.BindingShot)) MagicInfoList.Add(new MagicInfo { Name = "自然囚笼", Spell = Spell.BindingShot, Icon = 97, Level1 = 35, Level2 = 39, Level3 = 42, Need1 = 400, Need2 = 7000, Need3 = 9500, BaseCost = 7, LevelCost = 3, Range = 9 });
