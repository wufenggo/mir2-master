...
namespace Client.MirControls
{
    public sealed class MirGoodsCell : MirControl
    {
        ...
        public MirLabel NameLabel, PriceLabel, CountLabel;//which is this? lol
        public bool usePearls = false;//pearl currency
        public bool isRecipeShop = false;
        ...
        protected override void OnMouseEnter()
        {
            ...
            GameScene.Scene.CreateItemLabel(Item, false, false, true);
        }
