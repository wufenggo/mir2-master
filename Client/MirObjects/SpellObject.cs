        ...
        public void Load(S.ObjectSpell info)
        {
            ...
            switch (Spell)
            {
                ...
                case Spell.FrozenRains:
                    MapControl.Effects.Add(new Effect(Libraries.AltDataMagic, 35, 8, 2000, CurrentLocation, CMain.Time + 1000) { Start = CMain.Time + 3000 });
                    BodyLibrary = Libraries.AltDataMagic;
                    DrawFrame = 20;
                    FrameInterval = 100;
                    FrameCount = 11;
                    Light = 3;
                ...
                case Spell.SoulReaper:
                    BodyLibrary = Libraries.HeroComboSpell;
                    DrawFrame = 843;
                    FrameInterval = 110;
                    FrameCount = 10;
                    Light = 3;
