...
namespace Client.MirObjects
{
    class MonsterObject : MapObject
    {
        ...
        public int Level;
        public bool QuestMob = false;
        public bool EventMob = false;
        public bool IsPushable { get; private set; }
        public bool IsUndead { get; private set; }
        public int MoveSpeed { get; private set; }
        public uint Experience { get; private set; }
        public bool Enhanced = false;
        public string GlowAura;
        ...
        public void Load(S.ObjectMonster info, bool update = false)
        {
            ...
            Acc = info.Acc;
            Agil = info.Agil;
            AttkSpeed = info.AttkSpeed;
            CurrentHealth = info.CurrentHP;
            IsPet = info.IsPet;
            IsTamable = info.IsTamable;
            Level = info.Level;
            IsPushable = info.IsPushable;
            IsUndead = info.IsUndead;
            MoveSpeed = info.MoveSpeed;
            Experience = info.Experience;
            IsSub = info.IsSub;
            QuestMob = info.MobType == 1 ? true : false;
            EventMob = info.MobType == 2 ? true : false;
            Enhanced = info.PetEnhancer;
            if (QuestMob)
                Name = string.Format("{0}_[Quest]", Name);
            else if (EventMob)
                Name = string.Format("{0}_[Event]", Name);
            ...
            switch (BaseImage)
            {
                ...
                case Monster.SuperShinsu1:
                case Monster.SuperShinsu3:
                case Monster.SuperShinsu5:
                ...
                case Monster.FDung:
                case Monster.FDark:
                case Monster.FWoomaSoldier:
                case Monster.FWoomaFighter:
                case Monster.FWoomaWarrior:
                case Monster.FFlamingWooma:
                case Monster.FWoomaGuardian:
                case Monster.FWoomaTaurus:
                case Monster.Vulture:
                case Monster.OrcMiner:
                case Monster.OrcDagger:
                case Monster.OrcSpearthrower:
                case Monster.OrcWarrior:
                case Monster.OrcWithAnimal:
                case Monster.OrcRider:
                case Monster.OrcCook:
                case Monster.OrcMace:
                case Monster.AncCaveBat:
                case Monster.AncSkeleton:
                case Monster.AncBoneFighter:
                case Monster.AncAxeSkeleton:
                case Monster.AncBoneWarrior:
                case Monster.AncBoneElite:
                case Monster.SnowMouse:               
                ...
                case Monster.BoneFamiliar:
                    ...
                    break;
                case Monster.Shinsu:
                case Monster.SuperShinsu:
                case Monster.SuperShinsu2:
                case Monster.SuperShinsu4:
                ...
                case Monster.BoneFamiliar3:
                    ...
                    if (!info.Extra) ActionFeed.Add(new QueuedAction { Action = MirAction.Appear, Direction = Direction, Location = CurrentLocation });
                    break;
                case Monster.OrcCommander:
                    Frames = FrameSet.Monsters[211];
                    break;
                case Monster.OrcMutant:
                    Frames = FrameSet.Monsters[212];
                    break;
                case Monster.OrcGeneral:
                    Frames = FrameSet.Monsters[213];
                    break;
                case Monster.SandDragon:
                    Frames = FrameSet.Monsters[214];
                    break;
                case Monster.SecretPaper1:
                case Monster.SecretPaper2:
                case Monster.SecretPaper3:
                case Monster.SecretPaper4:
                    Stoned = info.Extra;
                    Frames = FrameSet.Monsters[215];
                    break;
                case Monster.SnowFlower:
                    Frames = FrameSet.Monsters[216];
                    break;
                case Monster.SnowFlowerQueen:
                    Frames = FrameSet.Monsters[217];
                    break;
                case Monster.SnowSnail:
                    Frames = FrameSet.Monsters[218];
                    break;
                case Monster.BeastKing:
                    Frames = FrameSet.Monsters[219];
                    break;
                case Monster.HolyDragon:
                case Monster.HolyDragon1:
                    Frames = FrameSet.Monsters[220];
                    if (!info.Extra) ActionFeed.Add(new QueuedAction { Action = MirAction.Appear, Direction = Direction, Location = CurrentLocation });
                    break;
                case Monster.GonRyunAch:
                    Frames = FrameSet.Monsters[221];
                    break;
                case Monster.GonRyunSin:
                case Monster.GonRyunMag:
                case Monster.GonRyunTao:
                    Frames = FrameSet.Monsters[222];
                    break;
                case Monster.GonRyunHam:
                    Frames = FrameSet.Monsters[223];
                    break;
                case Monster.GonRyunAchie:
                    Frames = FrameSet.Monsters[224];
                    break;
                case Monster.GonRyunWar:
                    Frames = FrameSet.Monsters[225];
                    break;
                case Monster.GonRyunBow:
                    Frames = FrameSet.Monsters[226];
                    break;
                case Monster.GonRyunSword:
                    Frames = FrameSet.Monsters[227];
                    break;
                case Monster.GonRyunSiner:
                    Frames = FrameSet.Monsters[228];
                    break;
                case Monster.GonRyunCaptin:
                    Frames = FrameSet.Monsters[229];
                    break;
                case Monster.NumaAxemen:
                case Monster.NumaBladesmen:
                case Monster.NumaClubber:
                case Monster.NumaFighter:
                case Monster.NumaMacemen:
                case Monster.NumaMage:                
                    Frames = FrameSet.Monsters[232];
                    break;
                case Monster.NumaRider:
                    Frames = FrameSet.Monsters[233];
                    break;
                case Monster.FalconLord:
                case Monster.BearMinotaur:
                    Frames = FrameSet.Monsters[234];
                    break;
                case (Monster)512: 
                case (Monster)513:
                case (Monster)517://BanyoWarrior - Teleport behind target
                case (Monster)519:
                case (Monster)520:
                case (Monster)521:
                case (Monster)522:// NumaMagic - Tbolt (Desert)
                case (Monster)523:
                case (Monster)526://Numa Elite (Desert)
                case (Monster)527:
                case (Monster)528:
                case (Monster)529:
                case (Monster)531:
                case (Monster)539:
                case (Monster)540://    Sand Shark -GreenPoison like effect (Desert)
                case (Monster)542://    WindfurySorceress - Ranged wind hit effect
                case (Monster)544://BanyoCaptain - 
                case (Monster)545:
                case (Monster)551:
                case (Monster)552:
                case (Monster)553:
                ...
                case (Monster)561:
                case (Monster)562:
                case (Monster)563://FlameGriffin - BlackPalace - Ranged (Flame projectile)
                case (Monster)564://StoneGriffin - BlackPalace - Ranged (white cloud projectile)
                case (Monster)565://MutantCaptain - BlackPalace - Hellfire (10 second delay)
                case (Monster)566://PinkGoddessofBlackPalace - BlackPalace thrust para
                case (Monster)567://GreenGoddessofBlackPalace - BlackPalace thrust para
                case (Monster)570:
                case (Monster)571:
                case (Monster)572:
                case (Monster)577:
                ...
                case (Monster)613:
                case (Monster)614:
                    Frames = FrameSet.Monsters[235];
                    break;
                case (Monster)514:
                    Frames = FrameSet.Monsters[236];
                    break;
                case (Monster)515:  //  Stone Golem - Appear -Ground, Die -Rubble (Desert)
                    Frames = FrameSet.Monsters[237];
                    if (!info.Extra) ActionFeed.Add(new QueuedAction { Action = MirAction.Appear, Direction = Direction, Location = CurrentLocation });
                    break;
                case (Monster)516:
                    Frames = FrameSet.Monsters[238];
                    break;
                case (Monster)518:
                    Frames = FrameSet.Monsters[239];
                    break;
                case (Monster)524:
                    Frames = FrameSet.Monsters[240];
                    break;
                case (Monster)525:
                    Frames = FrameSet.Monsters[241];
                    break;
                case (Monster)530:
                    Frames = FrameSet.Monsters[242];
                    break;
                case (Monster)533:
                    Frames = FrameSet.Monsters[243];
                    break;
                case (Monster)534:
                    Frames = FrameSet.Monsters[244];
                    break;
                case (Monster)536:
                    Frames = FrameSet.Monsters[245];
                    break;
                case (Monster)537:
                    Frames = FrameSet.Monsters[246];
                    break;
                case (Monster)538:
                    Frames = FrameSet.Monsters[247];
                    break;
                case Monster.Cactus:  //  Cursed Cactus
                    Frames = FrameSet.Monsters[248];
                    break;
                case (Monster)546:
                    Frames = FrameSet.Monsters[249];
                    break;
                case (Monster)548:
                    Frames = FrameSet.Monsters[250];
                    break;
                case (Monster)549:
                    Frames = FrameSet.Monsters[251];
                    break;
                case (Monster)554:
                    Frames = FrameSet.Monsters[252];
                    break;
                case (Monster)556:
                    Frames = FrameSet.Monsters[253];
                    break;
                case (Monster)557:
                    Frames = FrameSet.Monsters[254];
                    break;
                case (Monster)568:
                    Frames = FrameSet.Monsters[255];
                    break;
                case (Monster)569:
                    Frames = FrameSet.Monsters[256];
                    break;
                case (Monster)573:
                    Frames = FrameSet.Monsters[257];
                    break;
                case (Monster)575:
                    Frames = FrameSet.Monsters[258];
                    break;
                case (Monster)576:
                    Frames = FrameSet.Monsters[259];
                    break;
                case Monster.Taganda://Taganda
                    Frames = FrameSet.Monsters[260];
                    break;
                case (Monster)594:
                    Frames = FrameSet.Monsters[261];
                    break;
                case (Monster)597:
                    Frames = FrameSet.Monsters[262];
                    break;
                case (Monster)606:
                    Frames = FrameSet.Monsters[263];
                    break;
                case (Monster)607:
                    Frames = FrameSet.Monsters[264];
                    break;
                case (Monster)608:
                    Frames = FrameSet.Monsters[265];
                    break;
                case (Monster)609:
                    Frames = FrameSet.Monsters[266];
                    break;
                case (Monster)610:
                case (Monster)611:
                    Frames = FrameSet.Monsters[267];
                    break;
                case (Monster)612:
                    Frames = FrameSet.Monsters[268];
                    break;
                case (Monster)616:
                    Frames = FrameSet.Monsters[269];
                    break;
                case Monster.BabyPig:
                case Monster.Chick:
                case Monster.Kitten:
            ...
            ProcessBuffs();
            if (Enhanced)
                AddBuffEffect(BuffType.PetEnhancer);
            else if (HasPetEnhancer())
                RemoveBuffEffect(BuffType.PetEnhancer);
        }
        ...
        public bool HasPetEnhancer()
        {
                ...
                Effects.Count > 0)
            {
                for (int i = 0; i < Effects.Count; i++)
                {
                    if (Effects[i] is BuffEffect eff)
                        if (eff.BuffType == BuffType.PetEnhancer)
                            hasEffect = true;
                }
            }
            return hasEffect;
            ...
            else
            {
                ...
                switch (CurrentAction)
                {
                    ...
                    case MirAction.Hide:
                        ...
                        {
                            case Monster.SuperShinsu1:
                                BodyLibrary = Libraries.Monsters[(ushort)Monster.SuperShinsu];
                                BaseImage = Monster.SuperShinsu;
                                BaseSound = (ushort)BaseImage * 10;
                                Frames = FrameSet.Monsters[16];
                                Frames.Frames.TryGetValue(CurrentAction, out Frame);
                                break;
                            case Monster.SuperShinsu3:
                                BodyLibrary = Libraries.Monsters[(ushort)Monster.SuperShinsu2];
                                BaseImage = Monster.SuperShinsu2;
                                BaseSound = (ushort)BaseImage * 10;
                                Frames = FrameSet.Monsters[16];
                                Frames.Frames.TryGetValue(CurrentAction, out Frame);
                                break;
                            case Monster.SuperShinsu5:
                                BodyLibrary = Libraries.Monsters[(ushort)Monster.SuperShinsu4];
                                BaseImage = Monster.SuperShinsu4;
                                BaseSound = (ushort)BaseImage * 10;
                                Frames = FrameSet.Monsters[16];
                                Frames.Frames.TryGetValue(CurrentAction, out Frame);
                                break;
                ...
                switch (CurrentAction)
                {
                    ...
                    case MirAction.Attack1:
                        ...
                        switch (BaseImage)
                        {
                            case (Monster)540://SandShark
                                {
                                    Effects.Add(new Effect(Libraries.M3MobMagic, 82, 10, 300, ob));
                                }
                                break;
                            
                            case Monster.ElementGuard:
                                Effects.Add(new Effect(Libraries.Monsters[(ushort)Monster.ElementGuard], 360 + (int)Direction * 6, 10, 10 * 100, this));
                                break;
                            case Monster.FlamingWooma:
                            ...
                            case Monster.Manticore:
                                ...
                                break;
                            case Monster.TucsonMage:
                                Effects.Add(new Effect(Libraries.Monsters[(ushort)Monster.TucsonMage], 296 + (int)Direction * 10, 10, Frame.Count * Frame.Interval, this));
                                break;
                            case Monster.YinDevilNode:
                            ...
                            //Cat Cave mobs
                            case Monster.Jar1:
                                Effects.Add(new Effect(Libraries.Monsters[(ushort)Monster.Jar1], 130 + (int)Direction * 3, 3, 200, this));
                                break;
                            case Monster.FightingCat:
                                Effects.Add(new Effect(Libraries.Monsters[(ushort)Monster.FightingCat], 208 + (int)Direction * 2, 2, Frame.Count * Frame.Interval, this));
                                break;
                            case Monster.FireCat:
                                Effects.Add(new Effect(Libraries.Monsters[(ushort)Monster.FireCat], 248 + (int)Direction * 10, 10, Frame.Count * Frame.Interval, this));
                                break;
                            case Monster.CatWidow:
                                Effects.Add(new Effect(Libraries.Monsters[(ushort)Monster.CatWidow], 256 + (int)Direction * 3, 3, Frame.Count * Frame.Interval, this));
                                break;
                            case Monster.StainHammerCat:
                            ...
                            //Anc runes mobs
                            case Monster.DeathCrawler:
                                Effects.Add(new Effect(Libraries.Monsters[(ushort)Monster.DeathCrawler], 248 + (int)Direction * 3, 3, Frame.Count * Frame.Interval, this));
                                break;
                            case Monster.BurningZombie:
                                Effects.Add(new Effect(Libraries.Monsters[(ushort)Monster.BurningZombie], 312 + (int)Direction * 5, 5, Frame.Count * Frame.Interval, this));
                                break;
                            case Monster.FrozenZombie:
                                Effects.Add(new Effect(Libraries.Monsters[(ushort)Monster.FrozenZombie], 312 + (int)Direction * 5, 5, Frame.Count * Frame.Interval, this));
                                break;
                            case Monster.Demonwolf:
                            ...
                            case Monster.DarkBeast:
                                ...
                                break;
                            case Monster.HardenRhino:
                                Effects.Add(new Effect(Libraries.Monsters[(ushort)Monster.HardenRhino], 397 + (int)Direction * 6, 6, Frame.Count * Frame.Interval, this));
                                break;
                            case Monster.AncientBringer:
                                ...
                                Effects.Add(new Effect(Libraries.Monsters[(ushort)Monster.AncientBringer], 560, 8, 12 * Frame.Interval, this)
                                {
                            ...
                            //Snow Cave mobs
                            case Monster.SnowYeti:
                                Effects.Add(new Effect(Libraries.Monsters[(ushort)Monster.SnowYeti], 504 + (int)Direction * 4, 4, 4 * Frame.Interval, this));
                                break;
                            case Monster.FrozenKnight:
                                Effects.Add(new Effect(Libraries.Monsters[(ushort)Monster.FrozenKnight], 360 + (int)Direction * 2, 2, Frame.Count * Frame.Interval, this));
                                break;
                            case Monster.SecretPaper1:
                                Effects.Add(new Effect(Libraries.Monsters[(ushort)Monster.SecretPaper1], 296, 8, 8 * Frame.Interval, this));
                                break;
                            case Monster.SecretPaper2:
                                Effects.Add(new Effect(Libraries.Monsters[(ushort)Monster.SecretPaper2], 272, 10, 10 * Frame.Interval, this));
                                break;
                            case Monster.SnowFlower:
                                Effects.Add(new Effect(Libraries.Monsters[(ushort)Monster.SnowFlower], 661 + (int)Direction * 5, 5, Frame.Count * Frame.Interval, this));
                                break;
                            case Monster.SnowFlowerQueen:
                                Effects.Add(new Effect(Libraries.Monsters[(ushort)Monster.SnowFlowerQueen], 821 + (int)Direction * 3, 3, Frame.Count * FrameInterval, this));
                                break;
                            case Monster.SnowMouse:
                                Effects.Add(new Effect(Libraries.Monsters[(ushort)Monster.SnowMouse], 256 + (int)Direction * 4, 4, Frame.Count * FrameInterval, this));
                                break;
                            case Monster.SnowSnail:
                                Effects.Add(new Effect(Libraries.Monsters[(ushort)Monster.SnowSnail], 344 + (int)Direction * 4, 4, Frame.Count * FrameInterval, this));
                                break;
                            case Monster.RhinoWarrior:
                                Effects.Add(new Effect(Libraries.Monsters[(ushort)Monster.RhinoWarrior], 320 + (int)Direction * 8, 8, Frame.Count * Frame.Interval, this));
                                Effects.Add(new Effect(Libraries.Monsters[(ushort)Monster.RhinoWarrior], 383 + (int)Direction * 8, 8, Frame.Count * Frame.Interval, this));
                                break;
                            case Monster.RhinoPriest:
                                Effects.Add(new Effect(Libraries.Monsters[(ushort)Monster.RhinoPriest], 376 + (int)Direction * 9, 9, Frame.Count * Frame.Interval, this));
                                break;
                            //base index + Direction    * # of frames before next direction,FrameCount, FrameCount * Interval
                        }
                        break;
                    case MirAction.Attack2:
                        ...
                        switch (BaseImage)
                        {
                            ...
                            case Monster.ManectricKing:
                                ...
                                break;
                            case Monster.IceGuard:
                                Effects.Add(new Effect(Libraries.Monsters[(ushort)Monster.IceGuard], 256, 6, 400, this));
                                break;
                            case Monster.ElementGuard:
                                Effects.Add(new Effect(Libraries.Monsters[(ushort)Monster.ElementGuard], 320 + (int)Direction * 5, 10, 10 * 100, this));
                                break;
                            case Monster.AncientBringer:
                                Effects.Add(new Effect(Libraries.Monsters[(ushort)Monster.AncientBringer], 568 + (int)Direction * 10, 10, 10 * Frame.Interval, this));
                                break;
                            case Monster.FrozenKnight:
                                Effects.Add(new Effect(Libraries.Monsters[(ushort)Monster.FrozenKnight], 384 + (int)Direction * 8, 8, Frame.Count * Frame.Interval, this));
                                break;
                            case Monster.DeathCrawler:
                                Effects.Add(new Effect(Libraries.Monsters[(ushort)Monster.DeathCrawler], 272 + (int)Direction * 3, 3, Frame.Count * Frame.Interval, this));
                                break;
                            case Monster.Demonwolf:
                    ...
                    case MirAction.Attack3:
                        ...
                        switch (BaseImage)
                        {
                            ...
                            case Monster.Behemoth:
                                ...
                                break;
                            case Monster.AncientBringer:
                                Effects.Add(new Effect(Libraries.Monsters[(ushort)Monster.AncientBringer], 730 + (int)Direction * 24, 24, Frame.Count * Frame.Interval, this));
                                break;
                            case Monster.Manticore:
                                Effects.Add(new Effect(Libraries.Monsters[(ushort)Monster.Manticore], 496, 9, Frame.Count * Frame.Interval, this));
                                break;
                            case Monster.Taganda:
                                Effects.Add(new Effect(Libraries.M3MobMagic4, 448 , 10, 300, this));
                                break;
                        }
                        break;
                    ...
                    case MirAction.AttackRange1:
                        ...
                        {
                            case Monster.FlamingMutant:
                                Effects.Add(new Effect(Libraries.Monsters[(ushort)Monster.FlamingMutant], 314 + (int)Direction * 6, 6, Frame.Count * Frame.Interval, this));
                                break;
                            case Monster.KingScorpion:
                            ...
                            case Monster.IcePillar:
                                ...
                                break;
                            case Monster.SecretPaper3:
                                Effects.Add(new Effect(Libraries.Monsters[(int)BaseImage], 480, 10, 10 * Frame.Interval, this, 0L, false));
                                break;
                            case Monster.SecretPaper4:
                                {
                                    //Effects.Add(new Effect(Libraries.Monsters[(int)BaseImage], 480, 10, 10 * Frame.Interval, this, 0L, false));
                                    //bool flag31 = mapObject != null;
                                    //if (flag31)
                                    {
                                       // mapObject.Effects.Add(new Effect(Libraries.Monsters[(int)BaseImage], 487, 10, 10 * Frame.Interval, mapObject, 0L, false));
                                    }
                                    break;
                                }
                            case Monster.BurningZombie:
                                Effects.Add(new Effect(Libraries.Monsters[(ushort)Monster.BurningZombie], 352 + 10, 10, Frame.Count * Frame.Interval, this));
                                break;
                            case Monster.AncientBringer:
                                Effects.Add(new Effect(Libraries.Monsters[(ushort)Monster.AncientBringer], 648 + 5, 5, Frame.Count * Frame.Interval, this));
                                break;
                        }
                    ...
                    case MirAction.Die:
                        ...
                        {
                            case Monster.Taganda:
                                Effects.Add(new Effect(Libraries.M3MobMagic4, 532 + ((int)Direction * 10), 10, Frame.Count * Frame.Interval, this));
                                break;
                            case (Monster)515:
                                Effects.Add(new Effect(Libraries.M3MobMagic, 56, 10, 300, this));
                                break;
                            case Monster.ManectricKing:
                            ...
                            case Monster.BoneCaptain:
                                ...
                                break;
                            case Monster.FrozenSoldier:
                                Effects.Add(new Effect(Libraries.Monsters[(ushort)Monster.FrozenSoldier], 256 , 10, Frame.Count * FrameInterval, this));
                                break;
                            case Monster.RightGuard:
                            ...
                            case Monster.WingedTigerLord:
                                ...
                                break;
                            case Monster.BeastKing:
                                Effects.Add(new Effect(Libraries.Monsters[(ushort)Monster.BeastKing], 872 + (int)Direction * 5, 5, Frame.Count * FrameInterval, this));
                                break;
                            case Monster.HellKnight1:
                            case Monster.HellKnight2:
                            case Monster.HellKnight3:
                            case Monster.HellKnight4:
                                ...
                                break;
                            case Monster.SecretPaper1:
                                Effects.Add(new Effect(Libraries.Monsters[(ushort)Monster.SecretPaper1], 304, 11, Frame.Count * Frame.Interval, this));
                                break;
                            case Monster.SecretPaper2:
                                Effects.Add(new Effect(Libraries.Monsters[(ushort)Monster.SecretPaper2], 282, 11, Frame.Count * Frame.Interval, this));
                                break;
                            case Monster.SecretPaper3:
                            case Monster.SecretPaper4:
                                Effects.Add(new Effect(Libraries.Monsters[(ushort)BaseImage], 304, 11, Frame.Count * Frame.Interval, this));
                                break;
                            case Monster.SnowMouse:
                                Effects.Add(new Effect(Libraries.Monsters[(ushort)Monster.SnowMouse], 288, 8, Frame.Count * FrameInterval, this));
                                break;
                        }
                        PlayDieSound();
                        break;
                        ...
                        if (UpdateFrame() >= Frame.Count)
                        {
                            switch (BaseImage)
                            {
                                ...
                                case Monster.Shinsu:
                                    ...
                                    break;
                                case Monster.SuperShinsu:
                                    BodyLibrary = Libraries.Monsters[(ushort)Monster.SuperShinsu1];
                                    BaseImage = Monster.SuperShinsu1;
                                    BaseSound = (ushort)BaseImage * 10;
                                    Frames = FrameSet.Monsters[2];
                                    break;
                                case Monster.SuperShinsu2:
                                    BodyLibrary = Libraries.Monsters[(ushort)Monster.SuperShinsu3];
                                    BaseImage = Monster.SuperShinsu3;
                                    BaseSound = (ushort)BaseImage * 10;
                                    Frames = FrameSet.Monsters[2];
                                    break;
                                case Monster.SuperShinsu4:
                                    BodyLibrary = Libraries.Monsters[(ushort)Monster.SuperShinsu5];
                                    BaseImage = Monster.SuperShinsu5;
                                    BaseSound = (ushort)BaseImage * 10;
                                    Frames = FrameSet.Monsters[2];
                                    break;
                            }
                        ...
                        if (UpdateFrame() >= Frame.Count)
                        {
                            ...
                            if (SetAction())
                            {
                                switch (BaseImage)
                                {
                                    ...
                                    case Monster.DarkWraith:
                                        Effects.Add(new Effect(Libraries.Monsters[(ushort)Monster.DarkWraith], 720, 4, Frame.Count * FrameInterval, this));
                                        break;
                                    case Monster.IceCrystalSoldier:
                                        Effects.Add(new Effect(Libraries.Monsters[(ushort)Monster.IceCrystalSoldier], 464, 6, Frame.Count * FrameInterval, this));
                                        Effects.Add(new Effect(Libraries.Monsters[(ushort)Monster.IceCrystalSoldier], 474, 8, Frame.Count * FrameInterval, this));
                                        break;
                                ...
                                case 1:
                                    {
                                        ...
                                        {
                                            case Monster.OrcMiner:
                                                Effects.Add(new Effect(Libraries.Monsters[(ushort)Monster.OrcMiner], 224 + (int)Direction * 5, 5, 5 * FrameInterval, this));
                                                break;
                                            case Monster.CannibalTentacles:
                                                ...
                                                break;
                                            case Monster.OrcRider:
                                                Effects.Add(new Effect(Libraries.Monsters[(ushort)Monster.OrcRider], 224 + (int)Direction * 5, 5, 5 * Frame.Interval, this));
                                                break;
                                            case Monster.OrcGeneral:
                                                Effects.Add(new Effect(Libraries.Monsters[(ushort)Monster.OrcGeneral], 464 + (int)Direction * 10, 10, 8 * Frame.Interval, this));
                                                break;
                                            case Monster.SandDragon:
                                                Effects.Add(new Effect(Libraries.Monsters[(ushort)Monster.SandDragon], 320 + (int)Direction * 6, 6, 6 * Frame.Interval, this));
                                                break;
                                            case Monster.TucsonGeneral:
                                                Effects.Add(new Effect(Libraries.Monsters[(ushort)Monster.TucsonGeneral], 504 + (int)Direction * 5, 5, 5 * Frame.Interval, this));
                                                break;
                                        }
                                        break;
                                    }
                                case 3:
                                    {
                                        ...
                                        switch (BaseImage)
                                        {
                                            ...
                                            case Monster.LeftGuard:
                                                ...
                                                break;
                                            case Monster.TucsonWarrior:
                                                Effects.Add(new Effect(Libraries.Monsters[(ushort)Monster.TucsonWarrior], 297 + (int)Direction * 6, 6, 6 * Frame.Interval, this));
                                                break;
                                            case Monster.Shinsu1:
                                                Effects.Add(new Effect(Libraries.Monsters[(ushort)Monster.Shinsu1], 224 + (int)Direction * 6, 6, 6 * Frame.Interval, this));
                                                break;
                                            case Monster.SuperShinsu1:
                                                Effects.Add(new Effect(Libraries.Monsters[(ushort)Monster.SuperShinsu1], 224 + (int)Direction * 6, 6, 6 * Frame.Interval, this));
                                                break;
                                            case Monster.SuperShinsu3:
                                                Effects.Add(new Effect(Libraries.Monsters[(ushort)Monster.SuperShinsu3], 224 + (int)Direction * 6, 6, 6 * Frame.Interval, this));
                                                break;
                                            case Monster.SuperShinsu5:
                                                Effects.Add(new Effect(Libraries.Monsters[(ushort)Monster.SuperShinsu5], 224 + (int)Direction * 6, 6, 6 * Frame.Interval, this));
                                                break;
                                        }
                                        break;
                                    }
                                ...
                                case 4:
                                    {
                                        ...
                                        {
                                            case Monster.FrozenMiner:
                                                Effects.Add(new Effect(Libraries.Monsters[(ushort)Monster.FrozenMiner], 432 + (int)Direction * 3, 3, 3 * Frame.Interval, this));
                                                break;
                                            case Monster.FrozenAxeman:
                                                Effects.Add(new Effect(Libraries.Monsters[(ushort)Monster.FrozenAxeman], 528 + (int)Direction * 3, 3, 3 * Frame.Interval, this));
                                                break;
                                            case Monster.OrcWarrior:
                                                Effects.Add(new Effect(Libraries.Monsters[(ushort)Monster.OrcWarrior], 224 + (int)Direction * 3, 3, 3 * Frame.Interval, this));
                                                break;
                                            case Monster.OrcWithAnimal:
                                                Effects.Add(new Effect(Libraries.Monsters[(ushort)Monster.OrcWithAnimal], 224 + (int)Direction * 3, 3, 3 * Frame.Interval, this));
                                                break;
                                            case Monster.OrcMace:
                                                Effects.Add(new Effect(Libraries.Monsters[(ushort)Monster.OrcMace], 224 + (int)Direction * 2, 2, 3 * Frame.Interval, this));
                                                break;
                                            case Monster.OrcCommander: 
                                                Effects.Add(new Effect(Libraries.Monsters[(ushort)Monster.OrcCommander], 272 + (int)Direction * 3, 3, 3 * Frame.Interval, this));
                                                break;
                                            case Monster.Armadillo:
                                                int n = 0;
                                                if ((int)Direction >= 2)
                                                ...
                                                Effects.Add(new Effect(Libraries.Monsters[(ushort)Monster.Armadillo], 480+ n + (int)Direction * 2, 2, 2 * Frame.Interval, this));
                                                break;
                                            case Monster.ArmadilloElder:
                                ...
                                case 6:
                                    {
                                        ...
                                        {
                                            case Monster.OrcMace:
                                                Effects.Add(new Effect(Libraries.Monsters[(ushort)Monster.OrcMace], 240 + (int)Direction * 3, 3, 3 * Frame.Interval, this));
                                                break;
                                            case Monster.OrcMutant:
                                                Effects.Add(new Effect(Libraries.Monsters[(ushort)Monster.OrcMutant], 496, 4, 500, this));
                                                break;
                                            case Monster.DarkOmaKing:
                                ...
                                case 1:
                                    {
                                        switch (BaseImage)
                                        {
                                            case Monster.BabySnowMan:
                                                ...
                                                break;
                                                case Monster.OrcGeneral:
                                                Effects.Add(new Effect(Libraries.Monsters[(ushort)Monster.OrcGeneral], 544 + (int)Direction * 10, 10, 10 * Frame.Interval, this));
                                                break;
                                            case Monster.Armadillo:
                                                Effects.Add(new Effect(Libraries.Monsters[(ushort)Monster.Armadillo], 500 + (int)Direction * 12, 12, 12 * Frame.Interval, this));
                                                break;
                                            case Monster.DarkOmaKing:
                                ...
                                case 3:
                                    {
                                        ...
                                        {
                                            case Monster.DarkWraith:
                                                Effects.Add(new Effect(Libraries.Monsters[(ushort)Monster.DarkWraith], 750 + (int)Direction * 4, 4, Frame.Count * FrameInterval, this));
                                                break;
                                            case Monster.Behemoth:
                                            ...
                                            case Monster.FlameQueen:
                                                ...
                                                break;
                                            case Monster.FrozenMiner:
                                                Effects.Add(new Effect(Libraries.Monsters[(ushort)Monster.FrozenMiner], 462 + (int)Direction * 5, 5, 5 * Frame.Interval, this));
                                                break;
                                            case Monster.OrcMutant:
                                                Effects.Add(new Effect(Libraries.Monsters[(ushort)Monster.OrcMutant], 500 , 4, 4 * Frame.Interval, this));
                                                break;
                                            case Monster.TucsonGeneral:
                                ...
                                case 4:
                                    {
                                        ...
                                        {
                                            case Monster.OrcCommander:
                                                Effects.Add(new Effect(Libraries.Monsters[(ushort)Monster.OrcCommander], 296 + (int)Direction * 3, 3, 3 * Frame.Interval, this));
                                                break;
                                        }
                                        break;
                                    }
                                case 6:
                                    {
                                        ...
                                        {
                                            case Monster.OrcGeneral:
                                                Effects.Add(new Effect(Libraries.Monsters[(ushort)Monster.OrcGeneral], 624, 7, 7 * FrameInterval, this));
                                                break;
                                            case Monster.TucsonWarrior:
                                                Effects.Add(new Effect(Libraries.Monsters[(ushort)Monster.TucsonWarrior], 344 + (int)Direction * 9, 9, 9 * FrameInterval, this));
                                                break;
                                        }
                                        break;
                                    }
                                ...
                                case 1:
                                    switch (BaseImage)
                                    {
                                        case Monster.OlympicFlame:
                                            ...
                                            break;
                                        case Monster.OrcGeneral:
                                            Effects.Add(new Effect(Libraries.Monsters[(ushort)Monster.OrcGeneral], 631 + (int)Direction * 8, 8, 8 * Frame.Interval, this));
                                            break;
                                    }
                                    break;
                                case 3:
                                    {
                                        switch (BaseImage)
                                        {
                                            case Monster.WingedTigerLord:
                                                ...
                                                break;
                                            case Monster.BeastKing:
                                                Effects.Add(new Effect(Libraries.Monsters[(ushort)Monster.BeastKing], 854, 8, 600, this, 0, true));
                                                break;
                                            case Monster.OrcMutant:
                                                Effects.Add(new Effect(Libraries.Monsters[(ushort)Monster.OrcMutant], 504 + (int)Direction * 6, 6, 6 * Frame.Interval, this));
                                                break;
                                        }
                                    }
                                    break;
                                case 4:
                                    switch (BaseImage)
                                    {
                                        case Monster.OlympicFlame:
                                            ...
                                            break;
                                        case Monster.FrozenMagician:
                                            Effects.Add(new Effect(Libraries.Monsters[(ushort)Monster.FrozenMagician], 840 + (int)Direction * 4, 4, 4 * Frame.Interval, this));
                                            break;
                                        case Monster.Armadillo:
                                            Effects.Add(new Effect(Libraries.Monsters[(ushort)Monster.Armadillo], 596 , 12, 12 * Frame.Interval, this));
                                            break;
                                        case Monster.SandSnail:
                                            Effects.Add(new Effect(Libraries.Monsters[(ushort)Monster.SandSnail], 448, 9, 9 * Frame.Interval, this));
                                            break;
                                    }
                                    break;
                            }
                        ...
                        else
                        {
                            ...
                            switch (FrameIndex)
                            {
                                case 1:
                                    ...
                                    {
                                        case Monster.OrcMutant:
                                            Effects.Add(new Effect(Libraries.Monsters[(ushort)Monster.OrcMutant], 564 , 14, 14 * Frame.Interval, this));
                                            break;
                                    }
                                    break;
                            }
                            ...
                            switch (FrameIndex)
                            {
                                case 1:
                                    {
                                        switch (BaseImage)
                                        {
                                            case Monster.GuardianRock:
                                                ...
                                                break;
                                            case Monster.OrcWizard:
                                                Effects.Add(new Effect(Libraries.Monsters[(ushort)Monster.OrcWizard], 272, 6, 3 * Frame.Interval, this));
                                                break;
                                        }
                                        break;
                                    }
                                ...
                                case 4:
                                    {
                                        switch (BaseImage)
                                        {
                                            case (Monster)522://NumaMage
                                                ob = MapControl.GetObject(TargetID);
                                                if (ob != null)
                                                {
                                                    ob.Effects.Add(new Effect(Libraries.Magic, 10, 5, 300, ob));
                                                }
                                                break;
                                            case (Monster)542:
                                                ob = MapControl.GetObject(TargetID);
                                                if (ob != null)
                                                {
                                                    ob.Effects.Add(new Effect(Libraries.M3MobMagic, 529, 10, 300, ob, CMain.Time + 700));
                                                }
                                                break;
                                            case Monster.Taganda:
                                                Effects.Add(new Effect(Libraries.M3MobMagic4, 458 + ((int)Direction * 8), 8, 800, this));
                                                ob = MapControl.GetObject(TargetID);
                                                if (ob != null)
                                                    ob.Effects.Add(new Effect(Libraries.M3MobMagic4, 522, 10, 300, ob, CMain.Time + 700));
                                                break;
                                            case Monster.AxeSkeleton:
                                            ...
                                            case Monster.Cactus:
                                                if (MapControl.GetObject(TargetID) != null)
                                                    CreateProjectile(513, Libraries.M3MobMagic, true, 1, 30, 0);
                                                break;
                                            case Monster.FrozenMagician:
                                                if (MapControl.GetObject(TargetID) != null)
                                                {
                                                   missile =  CreateProjectile(560, Libraries.Monsters[(ushort)Monster.FrozenMagician], true, 6, 30, 0);
                                                    ...
                                                    if (missile.Target != null)
                                                    {
                                                        ...
                                                        {
                                                            missile.Target.Effects.Add(new Effect(Libraries.Monsters[(ushort)Monster.FrozenMagician], 830, 10, 600, missile.Target) { Blend = true });
                                                        };
                                                    }
                                                }
                                                break;
                                            case Monster.JinLord:
                                                if (MapControl.GetObject(TargetID) != null)
                                                {
                                                    missile = CreateProjectile(325, Libraries.M3MobMagic2, true, 6, 30, 0, true);
                                                    if (missile.Target != null)
                                                        missile.Complete += (o, e) => missile.Target.Effects.Add(new Effect(Libraries.M3MobMagic2, 147, 4, 400, missile.Target) { Blend = true });
                                                }
                                                break;
                                            case Monster.Dark:
                                                if (MapControl.GetObject(TargetID) != null)
                                            ...
                                            case Monster.OmaCannibal:
                                                if (MapControl.GetObject(TargetID) != null)
                                                {
                                                    missile = CreateProjectile(360, Libraries.Monsters[(ushort)Monster.OmaCannibal], true, 6, 30, 0);
                                                    if (missile.Target != null)
                                                        missile.Complete += (o, e) => missile.Target.Effects.Add(new Effect(Libraries.Monsters[(ushort)Monster.OmaCannibal], 456, 7, 400, missile.Target) { Blend = true });
                                                }
                                                break;
                                            case Monster.ZumaArcher:
                                            case Monster.BoneArcher:
                                            ...
                                            case Monster.CannibalTentacles:
                                                if (MapControl.GetObject(TargetID) != null)
                                                {
                                                    CreateProjectile(488, Libraries.Monsters[(ushort)Monster.CannibalTentacles], true, 8, 30, 1,false);
                                                }
                                                break;
                                            case Monster.TucsonGeneral:
                                                if (MapControl.GetObject(TargetID) != null)
                                                {
                                                    missile = CreateProjectile(592, Libraries.Monsters[(ushort)Monster.TucsonGeneral], false, 9, 30, 0, true);

                                                    if (missile.Target != null)
                                                    {
                                                        missile.Complete += (o, e) =>
                                                        {
                                                            missile.Target.Effects.Add(new Effect(Libraries.Monsters[(ushort)Monster.TucsonGeneral], 736, 8, 900, missile.Target) { Blend = true });
                                                        };
                                                    }
                                                }
                                                break;
                                            case Monster.MinotaurKing:
                                                ...
                                                if (ob != null)
                                                {
                                                    ob.Effects.Add(new Effect(Libraries.Monsters[(ushort)Monster.MinotaurKing], 320, 10, 1000, ob));
                                                }
                                                break;
                                            case Monster.AncientBringer:
                                                if (MapControl.GetObject(TargetID) != null)
                                                {
                                                    missile = CreateProjectile(688, Libraries.Monsters[(ushort)Monster.AncientBringer], true, 4, 30, 0);

                                                    if (missile.Target != null)
                                                    {
                                                        missile.Complete += (o, e) =>
                                                        {
                                                            missile.Target.Effects.Add(new Effect(Libraries.Monsters[(ushort)Monster.AncientBringer], 710, 10, 1000, missile.Target) { Blend = true });
                                                        };
                                                    }
                                                }
                                                break;
                                            case Monster.BurningZombie:
                                                if (MapControl.GetObject(TargetID) != null)
                                                {
                                                    ob.Effects.Add(new Effect(Libraries.Monsters[(ushort)Monster.BurningZombie], 362, 11, 1100, ob));
                                                    SoundManager.PlaySound(BaseSound + 6);
                                                }
                                                break;
                                            case Monster.MudZombie:
                                                if (MapControl.GetObject(TargetID) != null)
                                                {
                                                    ob.Effects.Add(new Effect(Libraries.Monsters[(ushort)Monster.MudZombie], 304, 13, 1300, ob));
                                                    SoundManager.PlaySound(BaseSound + 6);
                                                }
                                                break;
                                            case Monster.FrozenZombie:
                                                if (MapControl.GetObject(TargetID) != null)
                                                {
                                                    ob.Effects.Add(new Effect(Libraries.Monsters[(ushort)Monster.FrozenZombie], 352, 8, 800, ob));
                                                    SoundManager.PlaySound(BaseSound + 6);
                                                }
                                                break;
                                            case Monster.FrostTiger:
                                            ...
                                            case Monster.HolyDragon:
                                                ...
                                                if (ob != null)
                                                {
                                                    ob.Effects.Add(new Effect(Libraries.Dragon, 230, 5, 330, ob));
                                                    //ob.Effects.Add(new Effect(Libraries.Magic2, 10, 5, 300, ob));
                                                    SoundManager.PlaySound(BaseSound + 6);
                                                }
                                                break;
                                            case Monster.HolyDeva1:
                                                ...
                                                if (ob != null)
                                                {
                                                    ob.Effects.Add(new Effect(Libraries.Dragon, 200, 20, 600, ob));
                                                    //ob.Effects.Add(new Effect(Libraries.Magic2, 10, 5, 300, ob));
                                                    SoundManager.PlaySound(BaseSound + 6);
                                                }
                                                break;
                                            ...
                                            case Monster.BeastKing:
                                                ...
                                                if (ob != null)
                                                {
                                                    ob.Effects.Add(new Effect(Libraries.Monsters[(ushort)Monster.BeastKing], 862, 10, 800, ob, CMain.Time + 400, false));
                                                }
                                                break;
                                            case Monster.TrollBomber:
                                            ...
                                            case Monster.FlameAssassin:
                                                ...
                                                break;
                                            case Monster.OrcWizard:
                                                missile = CreateProjectile(278, Libraries.Monsters[(ushort)Monster.OrcWizard], true, 3, 20, 0);

                                                if (missile.Target != null)
                                                {
                                                    missile.Complete += (o, e) =>
                                                    {
                                                        missile.Target.Effects.Add(new Effect(Libraries.Monsters[(ushort)Monster.OrcWizard], 326, 3, 400, missile.Target));
                                                    };
                                                }
                                                break;
                                            case Monster.FlameQueen:
                                                ...
                                                break;
                                            case Monster.SecretPaper3:
                                                missile = CreateProjectile(490, Libraries.Monsters[(int)this.BaseImage], true, 5, 30, 5);

                                                if (missile.Target != null)
                                                {
                                                    missile.Complete += (o, e) =>
                                                    {
                                                        missile.Target.Effects.Add(new Effect(Libraries.Monsters[(ushort)Monster.SecretPaper3], 650, 8, 800, missile.Target));
                                                    };
                                                }
                                                break;
                                            case Monster.RhinoWarrior:
                                                ...
                                                if (ob != null)
                                                {
                                                    ob.Effects.Add(new Effect(Libraries.Monsters[(ushort)Monster.RhinoWarrior], 511, 17, 1000, ob));
                                                    ob.Effects.Add(new Effect(Libraries.Monsters[(ushort)Monster.RhinoWarrior], 447, 7, 1200, ob));
                                                }
                                                break;
                                            case Monster.RhinoPriest:
                                                ob = MapControl.GetObject(TargetID);
                                                if (ob != null)
                                                {
                                                    ob.Effects.Add(new Effect(Libraries.Monsters[(ushort)Monster.RhinoPriest], 448, 7, 1000, ob));
                                                }
                                                break;
                                            case Monster.SnowFlower:
                                                missile = CreateProjectile(490, Libraries.Monsters[(ushort)Monster.SnowFlower], true, 6, 100, 4, true);
                                                ...
                                                if (missile.Target != null)
                                                {
                                                    ...
                                                    {
                                                        if (missile.Target.CurrentAction == MirAction.Dead) return;
                                                        missile.Target.Effects.Add(new Effect(Libraries.Monsters[(ushort)Monster.SnowFlower], 650, 9, 500, missile.Target) { Blend = true });
                                                        SoundManager.PlaySound(20000 + (ushort)Spell.FrostCrunch * 10 + 2);
                                                    };
                                                }
                                                break;
                                            case Monster.SnowFlowerQueen:
                                                missile = CreateProjectile(650/* * (int)Direction * 5*/, Libraries.Monsters[(ushort)Monster.SnowFlowerQueen], true, 5, 100, 5, true);
                                                ...
                                                if (missile.Target != null)
                                                {
                                                    ...
                                                    {
                                                        if (missile.Target.CurrentAction == MirAction.Dead) return;
                                                        missile.Target.Effects.Add(new Effect(Libraries.Monsters[(ushort)Monster.SnowFlowerQueen], 900, 7, 500, missile.Target) { Blend = true });
                                                        SoundManager.PlaySound(20000 + (ushort)Spell.FrostCrunch * 10 + 2);
                                                    };
                                                }
                                                break;
                                            case Monster.SnowYeti:
                                                missile = CreateProjectile(560, Libraries.Monsters[(ushort)Monster.SnowYeti], true, 6, 6, 0, true);
                                                break;
                                            case Monster.OmaMage:
                                                missile = CreateProjectile(392, Libraries.Monsters[(ushort)Monster.OmaMage], true, 8, 100, 8, true);
                                                ...
                                                if (missile.Target != null)
                                                {
                                                    ...
                                                    {
                                                        if (missile.Target.CurrentAction == MirAction.Dead) return;
                                                        missile.Target.Effects.Add(new Effect(Libraries.Monsters[(ushort)Monster.OmaMage], 520, 9, 500, missile.Target) { Blend = true });
                                                        SoundManager.PlaySound(20000 + (ushort)Spell.FrostCrunch * 10 + 2);
                                                    };
                                                }
                                                break;
                                ...
                                case 5:
                                    switch (BaseImage)
                                    {
                                        case Monster.OrcDagger:
                                            if (MapControl.GetObject(TargetID) != null)
                                                CreateProjectile(224, Libraries.Monsters[(ushort)Monster.OrcDagger], true, 1, 10, 0);
                                            break;
                                        case Monster.OrcSpearthrower:
                                            if (MapControl.GetObject(TargetID) != null)
                                                CreateProjectile(224, Libraries.Monsters[(ushort)Monster.OrcSpearthrower], true, 1, 10, 0);
                                            break;
                                    }
                                    break;
                                case 6:
                                    switch (BaseImage)
                                    {
                                        case Monster.FrozenArcher:
                                            if (MapControl.GetObject(TargetID) != null)
                                                CreateProjectile(264, Libraries.Monsters[(ushort)Monster.FrozenArcher], true, 5, 30, 0);
                                            break;
                                    }
                                    break;
                            }
                                ...
                                case 1:
                                    {
                                        ...
                                        {
                                            case Monster.OrcWizard:
                                                Effects.Add(new Effect(Libraries.Monsters[(ushort)Monster.OrcWizard], 329, 20, 6 * Frame.Interval, this));
                                                break;
                                        }
                                        break;
                                ...
                                case 4:
                                    {
                                        ...
                                        switch (BaseImage)
                                        {
                                            ...
                                            case Monster.OrcWizard:
                                                ...
                                                if (ob != null)
                                                {
                                                    ob.Effects.Add(new Effect(Libraries.Monsters[(ushort)Monster.OrcWizard], 339, 10, 6 * Frame.Interval, ob));
                                                }
                                                break;
                                            case Monster.SnowFlowerQueen:
                                                Effects.Add(new Effect(Libraries.Monsters[(ushort)Monster.SnowFlowerQueen], 930, 10, 1000, this));

                                                ob = MapControl.GetObject(TargetID);
                                                if (ob != null)
                                                    ob.Effects.Add(new Effect(Libraries.Monsters[(ushort)Monster.SnowFlowerQueen], 910, 10, 10 * Frame.Interval, ob));
                                                break;
                                        }
                                        break;
                                    }
                                ...
                                case 1:
                                    switch (BaseImage)
                                    {
                                        ...
                                        case Monster.CyanoGhast:
                                            ...
                                            break;
                                        case Monster.OrcWithAnimal:
                                            Effects.Add(new Effect(Libraries.Monsters[(ushort)Monster.OrcWithAnimal], 248 + (int)Direction * 9, 9, 9 * Frame.Interval, this));
                                            break;
                                        case Monster.SandDragon:
                                            Effects.Add(new Effect(Libraries.Monsters[(ushort)Monster.SandDragon], 368 + (int)Direction * 10, 10, 10 * Frame.Interval, this));
                                            break;
                                        case Monster.DeathCrawler:
                                            Effects.Add(new Effect(Libraries.Monsters[(ushort)Monster.DeathCrawler], 313 + (int)Direction * 12, 12, 12 * FrameInterval, this));
                                            break;
                                        case Monster.BurningZombie:
                                            Effects.Add(new Effect(Libraries.Monsters[(ushort)Monster.BurningZombie], 373 + (int)Direction * 10, 10, 10 * FrameInterval, this));
                                            break;
                                        case Monster.MudZombie:
                                            break;
                                        case Monster.FrozenZombie:
                                            Effects.Add(new Effect(Libraries.Monsters[(ushort)Monster.FrozenZombie], 360 + (int)Direction * 10, 10, 10 * FrameInterval, this));
                                            break;
                                        case Monster.GasToad:
                                            Effects.Add(new Effect(Libraries.Monsters[(ushort)Monster.GasToad], 440, 9, Frame.Count * FrameInterval, this));
                                            break;
                                        case Monster.SwampWarrior:
                                            Effects.Add(new Effect(Libraries.Monsters[(ushort)Monster.SwampWarrior], 392, 8, Frame.Count * FrameInterval, this));
                                            break;
                                        case Monster.AssassinBird:
                                            Effects.Add(new Effect(Libraries.Monsters[(ushort)Monster.AssassinBird], 392, 9, Frame.Count * FrameInterval, this));
                                            break;
                                        case Monster.SwampSlime:
                                            Effects.Add(new Effect(Libraries.Monsters[(ushort)Monster.SwampSlime], 368, 9, Frame.Count * FrameInterval, this));
                                            break;
                                    }
                                    break;
                                case 3:
        ...
        public Missile CreateProjectile(int baseIndex, MLibrary library, bool blend, int count, int interval, int skip, bool direction16 = true)
        {
            MapObject ob = MapControl.GetObject(TargetID);
        ...
        public override void DrawEffects(bool effectsEnabled)
        {
            ...
            switch (BaseImage)
            {
                ...
                case Monster.JinLord:
                    ...
                    {
                        case MirAction.Attack1:
                            Libraries.M3MobMagic2.DrawBlend(151 + ((int)Direction * 9) + FrameIndex, DrawLocation, Color.White, true);
                            break;
                        case MirAction.AttackRange1:
                            Libraries.M3MobMagic2.DrawBlend(253 + ((int)Direction * 9) + FrameIndex, DrawLocation, Color.White, true);
                            break;
                        case MirAction.Die:
                            Direction = MirDirection.DownRight;
                            Libraries.M3MobMagic3.DrawBlend(233, DrawLocation, Color.White, true);
                            break;
                    }
                    break;
                case Monster.HolyDeva:
                ...
                case Monster.HolyDeva1:
                    ...
                    {
                        case MirAction.Standing:
                            Libraries.Monsters[(ushort)Monster.HolyDeva1].Draw(226 + FrameIndex + (int)Direction * 4, DrawLocation, Color.White, true);
                            break;
                        case MirAction.Walking:
                        case MirAction.Pushed:
                            Libraries.Monsters[(ushort)Monster.HolyDeva1].Draw(258 + FrameIndex + (int)Direction * 6, DrawLocation, Color.White, true);
                            break;
                        case MirAction.AttackRange1:
                            Libraries.Monsters[(ushort)Monster.HolyDeva1].Draw(306 + FrameIndex + (int)Direction * 6, DrawLocation, Color.White, true);
                            break;
                        case MirAction.Struck:
                            Libraries.Monsters[(ushort)Monster.HolyDeva1].Draw(354 + FrameIndex + (int)Direction * 2, DrawLocation, Color.White, true);
                            break;
                        case MirAction.Die:
                            if (FrameIndex <= 6) Libraries.Monsters[(ushort)Monster.HolyDeva1].Draw(370 + FrameIndex + (int)Direction * 6, DrawLocation, Color.White, true);
                            break;
                        case MirAction.Appear:
                            if (FrameIndex >= 5) Libraries.Monsters[(ushort)Monster.HolyDeva1].Draw(418 + FrameIndex - 5, DrawLocation, Color.White, true);
                            break;
                    }
                    break;
                ...
                case Monster.HolyDragon:
                    ...
                    {
                        case MirAction.Standing:
                            Libraries.Monsters[(ushort)Monster.HolyDragon].Draw(20 + FrameIndex + (int)Direction * 10, DrawLocation, Color.White, true);
                            break;
                        case MirAction.Walking:
                        case MirAction.Pushed:
                            Libraries.Monsters[(ushort)Monster.HolyDragon].Draw(100 + FrameIndex + (int)Direction * 10, DrawLocation, Color.White, true);
                            break;
                        case MirAction.AttackRange1:
                            Libraries.Monsters[(ushort)Monster.HolyDragon].Draw(180 + FrameIndex + (int)Direction * 10, DrawLocation, Color.White, true);
                            break;
                        case MirAction.Struck:
                            Libraries.Monsters[(ushort)Monster.HolyDragon].Draw(260 + FrameIndex + (int)Direction * 2, DrawLocation, Color.White, true);
                            break;
                        case MirAction.Die:
                            if (FrameIndex <= 6) Libraries.Monsters[(ushort)Monster.HolyDragon].Draw(280 + FrameIndex + (int)Direction * 10, DrawLocation, Color.White, true);
                            break;
                        case MirAction.Appear:
                            if (FrameIndex >= 6) Libraries.Monsters[(ushort)Monster.HolyDragon].Draw(4 + FrameIndex - 6, DrawLocation, Color.White, true);
                            break;
                    }
                    break;
                ...
                case Monster.HolyDragon1:
                    ...
                    {
                        case MirAction.Standing:
                            Libraries.Monsters[(ushort)Monster.HolyDragon1].Draw(20 + FrameIndex + (int)Direction * 10, DrawLocation, Color.White, true);
                            break;
                        case MirAction.Walking:
                        case MirAction.Pushed:
                            Libraries.Monsters[(ushort)Monster.HolyDragon1].Draw(100 + FrameIndex + (int)Direction * 10, DrawLocation, Color.White, true);
                            break;
                        case MirAction.AttackRange1:
                            Libraries.Monsters[(ushort)Monster.HolyDragon1].Draw(180 + FrameIndex + (int)Direction * 10, DrawLocation, Color.White, true);
                            break;
                        case MirAction.Struck:
                            Libraries.Monsters[(ushort)Monster.HolyDragon1].Draw(260 + FrameIndex + (int)Direction * 2, DrawLocation, Color.White, true);
                            break;
                        case MirAction.Die:
                            if (FrameIndex <= 6) Libraries.Monsters[(ushort)Monster.HolyDragon1].Draw(280 + FrameIndex + (int)Direction * 10, DrawLocation, Color.White, true);
                            break;
                        case MirAction.Appear:
                            if (FrameIndex >= 6) Libraries.Monsters[(ushort)Monster.HolyDragon1].Draw(4 + FrameIndex - 6, DrawLocation, Color.White, true);
                            break;
                    }
                    break;
                ...
                case Monster.FrozenRedZuma:
                    ...
                    {
                        case MirAction.Standing:
                            Libraries.Monsters[(ushort)Monster.FrozenRedZuma].DrawBlend(320 + FrameIndex + (int)Direction * 4, DrawLocation, Color.White, true);
                            break;
                        case MirAction.Walking:
                        case MirAction.Pushed:
                            Libraries.Monsters[(ushort)Monster.FrozenRedZuma].DrawBlend(352 + FrameIndex + (int)Direction * 6, DrawLocation, Color.White, true);
                            break;
                        case MirAction.Attack1:
                            Libraries.Monsters[(ushort)Monster.FrozenRedZuma].DrawBlend(400 + FrameIndex + (int)Direction * 6, DrawLocation, Color.White, true);
                            break;
                        case MirAction.Struck:
                            Libraries.Monsters[(ushort)Monster.FrozenRedZuma].DrawBlend(448 + FrameIndex + (int)Direction * 2, DrawLocation, Color.White, true);
                            break;
                        case MirAction.AttackRange1:
                            Libraries.Monsters[(ushort)Monster.FrozenRedZuma].DrawBlend(464 + FrameIndex + (int)Direction * 6, DrawLocation, Color.White, true);
                            break;
                    }
                    break;
                ...
                case Monster.CatShaman:
                    switch (CurrentAction)
                    {
                        ...
                        case MirAction.Pushed:
                            ...
                            break;
                        case MirAction.Attack1:
                            Libraries.Monsters[(ushort)Monster.CatShaman].DrawBlend(416 + FrameIndex + (int)Direction * 6, DrawLocation, Color.White, true);
                            break;
                        case MirAction.Attack2:
                            Libraries.Monsters[(ushort)Monster.CatShaman].DrawBlend(462 + FrameIndex + (int)Direction * 7, DrawLocation, Color.White, true);
                            break;
                        case MirAction.Die:
                            break;
                    }
                ...
                case Monster.BlackHammerCat:
                    switch (CurrentAction)
                    {
                        ...
                        case MirAction.Struck:
                            ...
                            break;
                        case MirAction.Die:
                            Libraries.Monsters[(ushort)Monster.BlackHammerCat].DrawBlend(592 + FrameIndex + (int)Direction * 10, DrawLocation, Color.White, true);
                            break;
                    }
                    break;
                case Monster.StrayCat:
                    ...
                    {
                        case MirAction.Attack1:
                            Libraries.Monsters[(ushort)Monster.StrayCat].DrawBlend(528 + FrameIndex + (int)Direction * 7, DrawLocation, Color.White, true);
                            break;
                        case MirAction.Attack3:
                            Libraries.Monsters[(ushort)Monster.StrayCat].DrawBlend(632 + FrameIndex + (int)Direction * 13, DrawLocation, Color.White, true);
                            break;
                    }
                    break;
                ...
                case Monster.BeastKing:
                    ...
                    {
                        case MirAction.Attack1:
                            if (FrameIndex >= 2) Libraries.Monsters[(ushort)Monster.BeastKing].DrawBlend(820 + (FrameIndex + (int)Direction * 4) - 2, DrawLocation, Color.White, true);
                            break;
                        case MirAction.Attack2:
                            if (FrameIndex >= 2) Libraries.Monsters[(ushort)Monster.BeastKing].DrawBlend(803 + (FrameIndex + (int)Direction * 2) - 2, DrawLocation, Color.White, true);
                            break;
                    }
                    break;
                ...
                case Monster.FrozenFighter:
                    switch (CurrentAction)
                    {
                        case MirAction.Attack1:
                            if (FrameIndex >= 3)
                                Libraries.Monsters[(ushort)Monster.FrozenFighter].DrawBlend(336 + (FrameIndex - 3) + (int)Direction * 6, DrawLocation, Color.White, true);
                            break;
                        case MirAction.Attack2:
                            if (FrameIndex >= 4)
                                Libraries.Monsters[(ushort)Monster.FrozenFighter].DrawBlend(384 + (FrameIndex - 4) + (int)Direction * 5, DrawLocation, Color.White, true);
                            break;
                    }
                    break;
                ...
                case Monster.DarkWraith:
                    switch (CurrentAction)
                    {
                        ...
                        case MirAction.Walking:
                            ...
                            break;
                        case MirAction.Struck:
                            Libraries.Monsters[(ushort)Monster.DarkWraith].DrawBlend(545 + FrameIndex + (int)Direction * 4, DrawLocation, Color.White, true);
                            break;
                        case MirAction.Attack1:
                            Libraries.Monsters[(ushort)Monster.DarkWraith].DrawBlend(440 + FrameIndex + (int)Direction * 8, DrawLocation, Color.White, true);
                            break;
                        case MirAction.Attack2:
                            Libraries.Monsters[(ushort)Monster.DarkWraith].DrawBlend(524 + FrameIndex + (int)Direction * 10, DrawLocation, Color.White, true);
                            break;
                        case MirAction.Die:
                            Libraries.Monsters[(ushort)Monster.DarkWraith].DrawBlend(637 + FrameIndex + (int)Direction * 10, DrawLocation, Color.White, true);
                            break;
                    }
                    break;
                ...
                case Monster.CrystalBeast:
                    ...
                    {
                        case MirAction.Standing:
                            Libraries.Monsters[(ushort)Monster.CrystalBeast].DrawBlend(880 + FrameIndex + (int)Direction * 6, DrawLocation, Color.White, true);
                            break;
                        case MirAction.Walking:
                        case MirAction.Pushed:
                            Libraries.Monsters[(ushort)Monster.CrystalBeast].DrawBlend(960 + FrameIndex + (int)Direction * 6, DrawLocation, Color.White, true);
                            break;
                        case MirAction.Attack1:
                            Libraries.Monsters[(ushort)Monster.CrystalBeast].DrawBlend(1200 + FrameIndex + (int)Direction * 8, DrawLocation, Color.White, true);
                            Effects.Add(new Effect(Libraries.Monsters[(ushort)Monster.CrystalBeast], 1761 + (int)Direction * 4, 7, 800, this));
                            break;
                        case MirAction.Attack2:
                            Libraries.Monsters[(ushort)Monster.CrystalBeast].DrawBlend(1200 + FrameIndex + (int)Direction * 8, DrawLocation, Color.White, true);
                            Effects.Add(new Effect(Libraries.Monsters[(ushort)Monster.CrystalBeast], 1850 + (int)Direction * 5, 7, 800, this));
                            break;
                        case MirAction.AttackRange1:
                            Libraries.Monsters[(ushort)Monster.CrystalBeast].DrawBlend(1280 + FrameIndex + (int)Direction * 6, DrawLocation, Color.White, true);
                            Effects.Add(new Effect(Libraries.Monsters[(ushort)Monster.CrystalBeast], 2100, 7, 800, this));
                            break;
                        case MirAction.AttackRange2:
                            Libraries.Monsters[(ushort)Monster.CrystalBeast].DrawBlend(1280 + FrameIndex + (int)Direction * 6, DrawLocation, Color.White, true);
                            Effects.Add(new Effect(Libraries.Monsters[(ushort)Monster.CrystalBeast], 2020 + (int)Direction * 10, 7, 800, this));
                            break;
                        case MirAction.AttackRange3:
                            Libraries.Monsters[(ushort)Monster.CrystalBeast].DrawBlend(1360 + FrameIndex + (int)Direction * 5, DrawLocation, Color.White, true);
                            Effects.Add(new Effect(Libraries.Monsters[(ushort)Monster.CrystalBeast], 1933 + (int)Direction * 5, 7, 800, this));
                            break;
                        case MirAction.Struck:
                            Libraries.Monsters[(ushort)Monster.CrystalBeast].DrawBlend(1120 + FrameIndex + (int)Direction * 5, DrawLocation, Color.White, true);
                            break;
                        case MirAction.Die:
                            break;
                    }
                ...
                case Monster.OrcGeneral:
                    ...
                    {
                        case MirAction.Standing:
                            Libraries.Monsters[(ushort)Monster.OrcGeneral].DrawBlend(432 + FrameIndex + (int)Direction * 4, DrawLocation, Color.White, true);
                            break;
                    }
                    break;
                ...
                case Monster.OmaBlest:
                    switch (CurrentAction)
                    {
                        case MirAction.Attack2: //atk 2 type 1
                            Libraries.Monsters[(ushort)Monster.OmaBlest].DrawBlend((392 + FrameIndex + (int)Direction * 5) - 5, DrawLocation, Color.White, true);
                            break;
                    }
                    break;
                ...
                case Monster.OmaSlasher:
                    ...
                    {
                        case MirAction.Attack1:
                            Libraries.Monsters[(ushort)Monster.OmaSlasher].DrawBlend((304 + FrameIndex + (int)Direction * 4) - 4, DrawLocation, Color.White, true);
                            break;
                    }
                    break;
                ...
                case Monster.OmaAssassin:
                    ...
                    {
                        case MirAction.Attack1:
                            Libraries.Monsters[(ushort)Monster.OmaAssassin].DrawBlend((312 + FrameIndex + (int)Direction * 5) - 5, DrawLocation, Color.White, true);
                            break;
                    }
                    break;
                ...
                case Monster.OmaWitchDoctor:
                    switch (CurrentAction)
                    {
                        ...
                        case MirAction.Struck:
                            ...
                            break;
                        case MirAction.Die:
                            Libraries.Monsters[(ushort)Monster.OmaWitchDoctor].DrawBlend(728 + FrameIndex + (int)Direction * 8, DrawLocation, Color.White, true);
                            break;
                    }
                    break;
                ...
                case Monster.LightningBead:
                    switch (CurrentAction)
                    {
                        ...
                        case MirAction.Attack1:
                            ...
                            break;
                        case MirAction.AttackRange1:
                            Libraries.Monsters[(ushort)Monster.LightningBead].DrawBlend(65 + FrameIndex, DrawLocation, Color.White, true);
                            break;
                        case MirAction.Struck:
                            Libraries.Monsters[(ushort)Monster.LightningBead].DrawBlend(42 + FrameIndex, DrawLocation, Color.White, true);
                            break;
                        case MirAction.Die:
                ...
                case Monster.HealingBead:
                    switch (CurrentAction)
                    {
                        ...
                        case MirAction.Attack1:
                            ...
                            break;
                        case MirAction.AttackRange1:
                            Libraries.Monsters[(ushort)Monster.HealingBead].DrawBlend(61 + FrameIndex, DrawLocation, Color.White, true);
                            break;
                        case MirAction.Struck:
                            Libraries.Monsters[(ushort)Monster.HealingBead].DrawBlend(42 + FrameIndex, DrawLocation, Color.White, true);
                            break;
                        case MirAction.Die:
                ...
                case Monster.PowerUpBead:
                    switch (CurrentAction)
                    {
                        case MirAction.Standing:
                            ...
                            break;
                        case MirAction.Attack1:
                            Libraries.Monsters[(ushort)Monster.PowerUpBead].DrawBlend(57 + FrameIndex, DrawLocation, Color.White, true);
                            break;
                        case MirAction.AttackRange1:
                            Libraries.Monsters[(ushort)Monster.PowerUpBead].DrawBlend(64 + FrameIndex, DrawLocation, Color.White, true);
                            break;
                        case MirAction.Struck:
                            Libraries.Monsters[(ushort)Monster.PowerUpBead].DrawBlend(42 + FrameIndex, DrawLocation, Color.White, true);
                            break;
                        case MirAction.Die:
                ...
                case Monster.Manticore:
                    ...
                    {
                        case MirAction.Attack2:
                            if (FrameIndex >= 3) Libraries.Monsters[(ushort)Monster.Manticore].DrawBlend((536 + FrameIndex + (int)Direction * 7), DrawLocation, Color.White, true);
                            break;
                    }
                    break;
        ...
        public override void DrawName()
        {
            ...
            //  Draw [Quest] only if the mob is alive
            if (QuestMob && !Dead)
            {
                CreateMonsterLabel(splitName[0], 0);
                CreateQuestLabel();
                QuestLabel.Text = "[Quest]";
                
                TempLabel.Text = splitName[0];
                TempLabel.Location = new Point(DisplayRectangle.X + (48 - TempLabel.Size.Width) / 2, DisplayRectangle.Y - (32 - TempLabel.Size.Height / 2) + (Dead ? 35 : 8) - (((1 - 1) * 10) / 2) + (0 * 12) + yOffset);
                QuestLabel.Location = new Point(DisplayRectangle.X + (48 - QuestLabel.Size.Width) / 2, TempLabel.Location.Y + TempLabel.Size.Height + 2);// I cheated :D
                QuestLabel.Draw();
                TempLabel.Draw();
            }
            else if (EventMob && !Dead)
            {
                CreateMonsterLabel(splitName[0], 0);
                CreateEventLabel();
                ...
                TempLabel.Text = splitName[0];
                TempLabel.Location = new Point(DisplayRectangle.X + (48 - TempLabel.Size.Width) / 2, DisplayRectangle.Y - (32 - TempLabel.Size.Height / 2) + (Dead ? 35 : 8) - (((1 - 1) * 10) / 2) + (0 * 12) + yOffset);
                EventLabel.Location = new Point(DisplayRectangle.X + (48 - EventLabel.Size.Width) / 2, TempLabel.Location.Y + TempLabel.Size.Height + 2);// I cheated :D
                EventLabel.Draw();
                TempLabel.Draw();
            }
            else
        ...
        public void CreateEventLabel()
        {
            EventLabel = null;
            for (int i = 0; i < LabelList.Count; i++)
            {
                if (LabelList[i].Text != "[Event]") continue;
                EventLabel = LabelList[i];
                break;
            }
            if (EventLabel != null && !EventLabel.IsDisposed) return;

            EventLabel = new MirLabel
            {
                AutoSize = true,
                BackColour = Color.Transparent,
                ForeColour =  Color.Plum,
                OutLine = true,
                OutLineColour = Color.Black,
                Text = "[Event]" ,
            };

            EventLabel.Disposing += (o, e) => LabelList.Remove(EventLabel);
            LabelList.Add(EventLabel);
        }

        public void CreateQuestLabel()
        {
            QuestLabel = null;
            for (int i = 0; i < LabelList.Count; i++)
            {
                if (LabelList[i].Text != "[Quest]") continue;
                QuestLabel = LabelList[i];
                break;
            }
            if (QuestLabel != null && !QuestLabel.IsDisposed) return;

            QuestLabel = new MirLabel
            {
                AutoSize = true,
                BackColour = Color.Transparent,
            ...
            QuestLabel.Disposing += (o, e) => LabelList.Remove(QuestLabel);
            LabelList.Add(QuestLabel);
        }
