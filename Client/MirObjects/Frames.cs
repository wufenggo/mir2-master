...
namespace Client.MirObjects
{
    public class FrameSet
    {
        ...
        static FrameSet()
        {
            ...
            frame.Frames.Add(MirAction.Attack1, new Frame(400, 6, 2, 100, 480, 6, 2, 100));
            ...
            frame.Frames.Add(MirAction.Mine, new Frame(392, 8, 0, 100, 392, 8, 0, 100));
            //Assassin
            ...
            HighPlayers.Add(frame = new FrameSet());
            frame.Frames.Add(MirAction.Standing, new Frame(0, 6, 2, 200, 0, 8, 0, 250));
            ...
            //21 6 frames
            NPCs.Add(frame = new FrameSet());
            frame.Frames.Add(MirAction.Standing, new Frame(0, 6, 0, 450));

            //22
            NPCs.Add(frame = new FrameSet());
            frame.Frames.Add(MirAction.Standing, new Frame(0, 4, 0, 450, 4, 4, 0, 450) { Blend = true });

            //23
            NPCs.Add(frame = new FrameSet());
            frame.Frames.Add(MirAction.Standing, new Frame(0, 10, 0, 250) { Blend = true });

            //24
            NPCs.Add(frame = new FrameSet());
            frame.Frames.Add(MirAction.Standing, new Frame(12, 4, 0, 450, 16, 4, 0, 450, 1, 10, 0, 250) { Blend = true });
            ...
            //28
            NPCs.Add(frame = new FrameSet());
            frame.Frames.Add(MirAction.Standing, new Frame(0, 8, 0, 450));

            //29
            NPCs.Add(frame = new FrameSet());
            frame.Frames.Add(MirAction.Standing, new Frame(0, 3, 0, 150));
            #endregion
            ...
            frame.Frames.Add(MirAction.Die, new Frame(260, 6, 4, 100));
            frame.Frames.Add(MirAction.Dead, new Frame(265, 1, 9, 1000));
            frame.Frames.Add(MirAction.Appear, new Frame(336, 10, -10, 100) { Blend = true });
            ...
            Monsters.Add(frame = new FrameSet());
            frame.Frames.Add(MirAction.Standing, new Frame(0, 4, 0, 500));
            frame.Frames.Add(MirAction.Attack1, new Frame(0, 4, 0, 500));
            ...
            frame.Frames.Add(MirAction.AttackRange1, new Frame(184, 10, 0, 100));
            frame.Frames.Add(MirAction.Struck, new Frame(344, 3, 0, 200));
            frame.Frames.Add(MirAction.Die, new Frame(368, 10, 0, 100));
            frame.Frames.Add(MirAction.Dead, new Frame(377, 1, 9, 1000));
            frame.Frames.Add(MirAction.Revive, new Frame(368, 10, 0, 100) { Reverse = true });
            ...
            frame.Frames.Add(MirAction.Walking, new Frame(80, 6, 0, 200));
            frame.Frames.Add(MirAction.Attack1, new Frame(128, 10, 0, 100));
            frame.Frames.Add(MirAction.Attack2, new Frame(128, 10, 0, 100));
            frame.Frames.Add(MirAction.Struck, new Frame(208, 3, 0, 200));
            ...
            frame.Frames.Add(MirAction.Revive, new Frame(24, 10, -10, 150) { Reverse = true });
            ...
            //167 - Manticore //mage ai needed black fox will do 4 now (373)
            Monsters.Add(frame = new FrameSet());
            frame.Frames.Add(MirAction.Standing, new Frame(0, 4, 0, 500) );
            frame.Frames.Add(MirAction.Walking, new Frame(112, 8, 0, 100) );
            frame.Frames.Add(MirAction.Attack1, new Frame(176, 8, 0, 100) { EffectStart = 496, EffectCount = 9, EffectInterval = 200, EffectSkip = 0 });
            frame.Frames.Add(MirAction.Attack3, new Frame(240, 7, 0, 100) { EffectStart = 496, EffectCount = 9, EffectInterval = 200, EffectSkip = 0 });
            frame.Frames.Add(MirAction.Attack2, new Frame(296, 7, 0, 100) { EffectStart = 496, EffectCount = 9, EffectInterval = 200, EffectSkip = 0 });
            frame.Frames.Add(MirAction.Struck, new Frame(352, 3, 0, 200) );
            ...
            //173 - OrcWizard //callisto orc mobs
            Monsters.Add(frame = new FrameSet());
            frame.Frames.Add(MirAction.Standing, new Frame(0, 4, 0, 500));
            frame.Frames.Add(MirAction.Walking, new Frame(32, 6, 0, 200));
            frame.Frames.Add(MirAction.AttackRange1, new Frame(80, 6, 0, 100));
            ...
            frame.Frames.Add(MirAction.Attack2, new Frame(32, 10, 0, 100));
            ...
            Monsters.Add(frame = new FrameSet());
            frame.Frames.Add(MirAction.Standing, new Frame(0, 6, 4, 500));
            frame.Frames.Add(MirAction.Walking, new Frame(80, 6, 4, 200));
            frame.Frames.Add(MirAction.Attack1, new Frame(160, 5, 5, 100));
            frame.Frames.Add(MirAction.Attack2, new Frame(240, 5, 5, 100));
            frame.Frames.Add(MirAction.Attack3, new Frame(320, 8, 2, 100));
            frame.Frames.Add(MirAction.AttackRange1, new Frame(400, 6, 4, 100));
            frame.Frames.Add(MirAction.AttackRange2, new Frame(480, 5, 5, 100));
            frame.Frames.Add(MirAction.AttackRange3, new Frame(640, 8, 2, 100));
            frame.Frames.Add(MirAction.Struck, new Frame(720, 3, 7, 200));
            frame.Frames.Add(MirAction.Die, new Frame(800, 8, 2, 100));
            frame.Frames.Add(MirAction.Dead, new Frame(807, 1, 9, 1000));
            frame.Frames.Add(MirAction.Revive, new Frame(800, 8, 2, 100) { Reverse = true });
            ...
            frame.Frames.Add(MirAction.Attack3, new Frame(320, 13, 0, 200));
            ...
            //208 - BoneFamilar1 // Ice New Skellys
            Monsters.Add(frame = new FrameSet());
            frame.Frames.Add(MirAction.Standing, new Frame(0, 4, 6, 500));
            frame.Frames.Add(MirAction.Walking, new Frame(80, 6, 4, 100));
            frame.Frames.Add(MirAction.Attack1, new Frame(160, 6, 4, 100));
            ...
            //209 - BoneFamilar2 // Ice New Skellys
            Monsters.Add(frame = new FrameSet());
            frame.Frames.Add(MirAction.Standing, new Frame(0, 4, 6, 500));
            frame.Frames.Add(MirAction.Walking, new Frame(80, 6, 4, 100));
            frame.Frames.Add(MirAction.Attack1, new Frame(160, 6, 4, 100));
            ...
            //210 - BoneFamilar3 // Ice New Skellys
            Monsters.Add(frame = new FrameSet());
            frame.Frames.Add(MirAction.Standing, new Frame(0, 4, 6, 500));
            frame.Frames.Add(MirAction.Walking, new Frame(80, 6, 4, 100));
            frame.Frames.Add(MirAction.Attack1, new Frame(160, 6, 4, 100));
            ...
            //212 - OrcMutant //callisto orc mobs
            Monsters.Add(frame = new FrameSet());
            frame.Frames.Add(MirAction.Standing, new Frame(0, 4, 0, 500));
            frame.Frames.Add(MirAction.Walking, new Frame(32, 6, 0, 100));
            frame.Frames.Add(MirAction.Attack1, new Frame(80, 8, 0, 100));
            ...
            //213 - OrcGeneral //callisto orc mobs
            Monsters.Add(frame = new FrameSet());
            frame.Frames.Add(MirAction.Standing, new Frame(0, 4, 0, 500));
            frame.Frames.Add(MirAction.Walking, new Frame(32, 6, 0, 100));
            frame.Frames.Add(MirAction.Attack1, new Frame(80, 10, 0, 100));
            ...
            //214 - sanddragon //callisto orc mobs
            Monsters.Add(frame = new FrameSet());
            frame.Frames.Add(MirAction.Show, new Frame(0, 9, 0, 100));
            frame.Frames.Add(MirAction.Hide, new Frame(8, 9, 0, 100) { Reverse = true });
            frame.Frames.Add(MirAction.Walking, new Frame(72, 9, 0, 100));
            frame.Frames.Add(MirAction.Standing, new Frame(144, 4, 0, 500));
            frame.Frames.Add(MirAction.Attack1, new Frame(176, 6, 0, 100));
            frame.Frames.Add(MirAction.Struck, new Frame(224, 2, 0, 200));
            frame.Frames.Add(MirAction.Die, new Frame(240, 10, 0, 100));
            frame.Frames.Add(MirAction.Dead, new Frame(249, 1, 9, 1000));
            frame.Frames.Add(MirAction.Revive, new Frame(240, 20, 0, 100) { Reverse = true });

            //215 SecretPapers
            Monsters.Add(frame = new FrameSet());
            frame.Frames.Add(MirAction.Standing, new Frame(0, 4, 0, 500));
            frame.Frames.Add(MirAction.Stoned, new Frame(0, 4, 0, 500));
            frame.Frames.Add(MirAction.Show, new Frame(32, 5, 0, 100));
            frame.Frames.Add(MirAction.Die, new Frame(224, 3, 0, 100));
            frame.Frames.Add(MirAction.Dead, new Frame(224, 1, 9, 1000));
            frame.Frames.Add(MirAction.Hide, new Frame(32, 5, 0, 100)
            {
                Reverse = true
            });
            ...
            //216 SnowFlower
            Monsters.Add(frame = new FrameSet());
            frame.Frames.Add(MirAction.Standing, new Frame(0, 9, 1, 500));
            frame.Frames.Add(MirAction.Walking, new Frame(80, 7, 3, 200));
            frame.Frames.Add(MirAction.Attack1, new Frame(160, 7, 3, 100));
            frame.Frames.Add(MirAction.Attack2, new Frame(240, 7, 2, 100));
            frame.Frames.Add(MirAction.Struck, new Frame(320, 3, 7, 200));
            frame.Frames.Add(MirAction.Die, new Frame(400, 7, 3, 100));
            frame.Frames.Add(MirAction.Dead, new Frame(400, 1, 7, 1000));

            //217 SnowFlowerQueen
            Monsters.Add(frame = new FrameSet());
            frame.Frames.Add(MirAction.Standing, new Frame(0, 8, 2, 500));
            frame.Frames.Add(MirAction.Walking, new Frame(80, 6, 4, 200));
            frame.Frames.Add(MirAction.Attack1, new Frame(160, 8, 2, 100));
            frame.Frames.Add(MirAction.Attack2, new Frame(240, 6, 4, 100));
            frame.Frames.Add(MirAction.Attack3, new Frame(320, 9, 1, 100));
            frame.Frames.Add(MirAction.Struck, new Frame(400, 7, 3, 200));
            frame.Frames.Add(MirAction.Die, new Frame(560, 9, 1, 100));
            frame.Frames.Add(MirAction.Dead, new Frame(560, 1, 9, 1000));
            ...
            frame.Frames.Add(MirAction.Attack1, new Frame(104, 8, 0, 100));
            frame.Frames.Add(MirAction.Struck, new Frame(168, 10, 0, 200));
            frame.Frames.Add(MirAction.Die, new Frame(248, 5, 0, 100));
            frame.Frames.Add(MirAction.Dead, new Frame(248, 1, 4, 1000));

            //219 - BeastKing
            Monsters.Add(frame = new FrameSet());
            frame.Frames.Add(MirAction.Standing, new Frame(0, 6, 4, 500));
            frame.Frames.Add(MirAction.Walking, new Frame(80, 6, 4, 100));
            frame.Frames.Add(MirAction.Attack1, new Frame(480, 8, 2, 100));
            frame.Frames.Add(MirAction.Attack2, new Frame(400, 5, 5, 100));
            frame.Frames.Add(MirAction.Attack3, new Frame(560, 5, 5, 150));
            frame.Frames.Add(MirAction.AttackRange1, new Frame(640, 8, 2, 150));
            frame.Frames.Add(MirAction.Struck, new Frame(240, 3, 7, 200));
            frame.Frames.Add(MirAction.Die, new Frame(320, 9, 0, 100));
            frame.Frames.Add(MirAction.Dead, new Frame(328, 1, 9, 1000));
            frame.Frames.Add(MirAction.Revive, new Frame(320, 9, 0, 100) { Reverse = true });

            //220 - HolyDragon
            Monsters.Add(frame = new FrameSet());
            frame.Frames.Add(MirAction.Appear, new Frame(14, 6, -6, 100) { Blend = true });
            frame.Frames.Add(MirAction.Standing, new Frame(360, 4, 6, 500) { Blend = true });
            frame.Frames.Add(MirAction.Walking, new Frame(440, 6, 4, 100) { Blend = true });
            frame.Frames.Add(MirAction.AttackRange1, new Frame(520, 6, 4, 100) { Blend = true });
            frame.Frames.Add(MirAction.Struck, new Frame(600, 2, 0, 200) { Blend = true });
            frame.Frames.Add(MirAction.Die, new Frame(620, 6, 4, 100) { Blend = true });
            frame.Frames.Add(MirAction.Revive, new Frame(620, 6, 4, 100) { Blend = true, Reverse = true });

            //221 GonRyun Mobs Ach
            Monsters.Add(frame = new FrameSet());
            frame.Frames.Add(MirAction.Standing, new Frame(0, 8, 2, 500));
            frame.Frames.Add(MirAction.Walking, new Frame(80, 6, 4, 100));
            frame.Frames.Add(MirAction.Attack1, new Frame(160, 8, 2, 100));
            frame.Frames.Add(MirAction.Struck, new Frame(400, 3, 7, 200));
            frame.Frames.Add(MirAction.Die, new Frame(480, 10, 0, 100));
            frame.Frames.Add(MirAction.Dead, new Frame(480, 1, 9, 1000));
            frame.Frames.Add(MirAction.Revive, new Frame(480, 10, 0, 100) { Reverse = true });

            //222 GonRyun Mobs Sin
            Monsters.Add(frame = new FrameSet());
            frame.Frames.Add(MirAction.Standing, new Frame(0, 6, 4, 500));
            frame.Frames.Add(MirAction.Walking, new Frame(80, 6, 4, 100));
            frame.Frames.Add(MirAction.Attack1, new Frame(160, 8, 2, 100));
            ...
            //223 GonRyun Mobs Ham
            Monsters.Add(frame = new FrameSet());
            frame.Frames.Add(MirAction.Standing, new Frame(0, 6, 4, 500));
            frame.Frames.Add(MirAction.Walking, new Frame(80, 6, 4, 100));
            frame.Frames.Add(MirAction.Attack1, new Frame(160, 8, 2, 100));
            frame.Frames.Add(MirAction.Struck, new Frame(400, 3, 7, 200));
            frame.Frames.Add(MirAction.Die, new Frame(480, 8, 2, 100));
            frame.Frames.Add(MirAction.Dead, new Frame(487, 1, 7, 1000));
            frame.Frames.Add(MirAction.Revive, new Frame(480, 8, 2, 100) { Reverse = true });

            //224 GonRyun Mobs Achie
            Monsters.Add(frame = new FrameSet());
            frame.Frames.Add(MirAction.Standing, new Frame(0, 6, 4, 500));
            frame.Frames.Add(MirAction.Walking, new Frame(80, 6, 4, 100));
            frame.Frames.Add(MirAction.Attack1, new Frame(160, 8, 2, 100));
            frame.Frames.Add(MirAction.Struck, new Frame(320, 3, 7, 200));
            frame.Frames.Add(MirAction.Die, new Frame(400, 8, 2, 100));
            frame.Frames.Add(MirAction.Dead, new Frame(407, 1, 7, 1000));
            frame.Frames.Add(MirAction.Revive, new Frame(400, 8, 2, 100) { Reverse = true });

            //225 GonRyun Mobs War
            Monsters.Add(frame = new FrameSet());
            frame.Frames.Add(MirAction.Standing, new Frame(0, 6, 4, 500));
            frame.Frames.Add(MirAction.Walking, new Frame(80, 6, 4, 100));
            frame.Frames.Add(MirAction.Attack1, new Frame(160, 8, 2, 100));
            frame.Frames.Add(MirAction.Struck, new Frame(400, 4, 6, 200));
            frame.Frames.Add(MirAction.Die, new Frame(480, 8, 2, 100));
            frame.Frames.Add(MirAction.Dead, new Frame(487, 1, 7, 1000));
            frame.Frames.Add(MirAction.Revive, new Frame(480, 8, 2, 100) { Reverse = true });

            //226 GonRyun Mobs Bow
            Monsters.Add(frame = new FrameSet());
            frame.Frames.Add(MirAction.Standing, new Frame(0, 6, 4, 500));
            frame.Frames.Add(MirAction.Walking, new Frame(80, 6, 4, 100));
            frame.Frames.Add(MirAction.Attack1, new Frame(160, 9, 2, 100));
            frame.Frames.Add(MirAction.Struck, new Frame(400, 3, 7, 200));
            frame.Frames.Add(MirAction.Die, new Frame(480, 8, 2, 100));
            frame.Frames.Add(MirAction.Dead, new Frame(487, 1, 7, 1000));
            frame.Frames.Add(MirAction.Revive, new Frame(480, 8, 2, 100) { Reverse = true });

            //227 GonRyun Mobs Sword
            Monsters.Add(frame = new FrameSet());
            frame.Frames.Add(MirAction.Standing, new Frame(0, 6, 4, 500));
            frame.Frames.Add(MirAction.Walking, new Frame(80, 6, 4, 100));
            frame.Frames.Add(MirAction.Attack1, new Frame(160, 8, 2, 100));
            frame.Frames.Add(MirAction.Struck, new Frame(400, 3, 7, 200));
            frame.Frames.Add(MirAction.Die, new Frame(480, 10, 0, 100));
            frame.Frames.Add(MirAction.Dead, new Frame(489, 1, 9, 1000));
            frame.Frames.Add(MirAction.Revive, new Frame(480, 10, 0, 100) { Reverse = true });

            //228 GonRyun Mobs Siner
            Monsters.Add(frame = new FrameSet());
            frame.Frames.Add(MirAction.Standing, new Frame(0, 6, 4, 500));
            frame.Frames.Add(MirAction.Walking, new Frame(80, 6, 4, 100));
            frame.Frames.Add(MirAction.Attack1, new Frame(160, 8, 2, 100));
            frame.Frames.Add(MirAction.Struck, new Frame(400, 4, 6, 200));
            frame.Frames.Add(MirAction.Die, new Frame(480, 9, 1, 100));
            frame.Frames.Add(MirAction.Dead, new Frame(488, 1, 8, 1000));
            frame.Frames.Add(MirAction.Revive, new Frame(480, 9, 1, 100) { Reverse = true });
            ...
            frame.Frames.Add(MirAction.Attack1, new Frame(160, 8, 2, 100));
            frame.Frames.Add(MirAction.Struck, new Frame(400, 3, 7, 200));
            frame.Frames.Add(MirAction.Die, new Frame(1120, 10, 0, 100));
            frame.Frames.Add(MirAction.Dead, new Frame(1120, 1, 9, 1000));
            frame.Frames.Add(MirAction.Revive, new Frame(1120, 10, 0, 100) { Reverse = true });
            ...
            frame.Frames.Add(MirAction.Walking, new Frame(48, 10, 0, 100));
            frame.Frames.Add(MirAction.Attack1, new Frame(128, 10, 0, 100));
            frame.Frames.Add(MirAction.Attack2, new Frame(208, 9, 0, 100));
            frame.Frames.Add(MirAction.Attack3, new Frame(272, 8, 0, 100));
            frame.Frames.Add(MirAction.Struck, new Frame(336, 2, 0, 200));
            frame.Frames.Add(MirAction.Die, new Frame(352, 8, 0, 200));
            frame.Frames.Add(MirAction.Dead, new Frame(359, 1, 10, 100));
            ...
            frame.Frames.Add(MirAction.Attack1, new Frame(176, 8, 0, 100));
            frame.Frames.Add(MirAction.Attack2, new Frame(296, 7, 0, 100));
            frame.Frames.Add(MirAction.Attack3, new Frame(32, 10, 0, 100));
            frame.Frames.Add(MirAction.Struck, new Frame(352, 3, 0, 200));
            frame.Frames.Add(MirAction.Die, new Frame(381, 10, 4, 200));
            frame.Frames.Add(MirAction.Dead, new Frame(390, 1, 14, 100));
            //232 502 + 503 + 504 + 506 + 507 + 508
            Monsters.Add(frame = new FrameSet());
            frame.Frames.Add(MirAction.Standing, new Frame(0, 4, 0, 500));
            frame.Frames.Add(MirAction.Walking, new Frame(32, 6, 0, 100));
            frame.Frames.Add(MirAction.Attack1, new Frame(80, 6, 0, 100));
            ...
            frame.Frames.Add(MirAction.Standing, new Frame(0, 4, 0, 500));
            frame.Frames.Add(MirAction.Walking, new Frame(32, 6, 0, 100));
            frame.Frames.Add(MirAction.Attack1, new Frame(224, 6, 0, 100));
            frame.Frames.Add(MirAction.Struck, new Frame(128, 2, 0, 200));
            frame.Frames.Add(MirAction.Die, new Frame(144, 10, 0, 100));
            frame.Frames.Add(MirAction.Dead, new Frame(153, 1, 9, 1000));
            //234 509 + 510
            ...
            //235 - 512 - 513 - 517 - 519 - 520(attack2) - 521 - 522 - 523 - 526 - 527 - 528 - 529 - 531 - 539 - 540 - 542 - 544
            //      545 - 551 - 552 - 553 - 558          - 559 - 560 - 561 - 562 - 563 - 564 - 565 - 566 - 567 - 570 - 571 - 572 
            //      577 - 578 - 580 - 581 - 582          - 587 - 588 - 589 - 590 - 591 - 592 - 593 - 595 - 596 - 598 - 599 - 600
            //      601 - 602 - 603 - 604 - 605          - 613 - 614
            Monsters.Add(frame = new FrameSet());
            frame.Frames.Add(MirAction.Standing, new Frame(0, 4, 0, 500));
            frame.Frames.Add(MirAction.Walking, new Frame(32, 6, 0, 100));
            frame.Frames.Add(MirAction.Attack1, new Frame(80, 6, 0, 100));
            frame.Frames.Add(MirAction.Attack2, new Frame(224, 6, 0, 100));
            frame.Frames.Add(MirAction.Attack3, new Frame(272, 6, 0, 100));
            frame.Frames.Add(MirAction.AttackRange1, new Frame( 32, 6, 0, 100));
            frame.Frames.Add(MirAction.AttackRange2, new Frame(224, 6, 0, 100));
            frame.Frames.Add(MirAction.AttackRange3, new Frame(272, 6, 0, 100));
            frame.Frames.Add(MirAction.Struck, new Frame(128, 2, 0, 200));
            frame.Frames.Add(MirAction.Die, new Frame(144, 10, 0, 100));
            frame.Frames.Add(MirAction.Dead, new Frame(153, 1, 9, 1000));
            //236 - 514
            ...
            frame.Frames.Add(MirAction.Standing, new Frame(0, 3, 0, 500));
            frame.Frames.Add(MirAction.Walking, new Frame(0, 3, 0, 100));
            frame.Frames.Add(MirAction.Attack1, new Frame(0, 3, 0, 100));
            frame.Frames.Add(MirAction.Struck, new Frame(0, 3, 0, 200));
            frame.Frames.Add(MirAction.Die, new Frame(3, 5, 0, 100));
            frame.Frames.Add(MirAction.Dead, new Frame(7, 1, 0, 1000));
            //237 - 515
            Monsters.Add(frame = new FrameSet());
            frame.Frames.Add(MirAction.Appear, new Frame(224, 10, 0, 100));
            frame.Frames.Add(MirAction.Standing, new Frame(0, 4, 0, 500));
            frame.Frames.Add(MirAction.Walking, new Frame(32, 6, 0, 100));
            frame.Frames.Add(MirAction.Attack1, new Frame(80, 6, 0, 100));
            frame.Frames.Add(MirAction.Struck, new Frame(128, 2, 0, 200));
            ...
            frame.Frames.Add(MirAction.Standing, new Frame(0, 10, 0, 500));
            frame.Frames.Add(MirAction.Walking, new Frame(0, 10, 0, 100));
            frame.Frames.Add(MirAction.Attack1, new Frame(0, 10, 0, 100));
            frame.Frames.Add(MirAction.Struck, new Frame(0, 10, 0, 200));
            frame.Frames.Add(MirAction.Die, new Frame(0, 10, 0, 100));
            frame.Frames.Add(MirAction.Dead, new Frame(0, 10, 0, 1000));
            //239 - 518
            Monsters.Add(frame = new FrameSet());
            frame.Frames.Add(MirAction.Standing, new Frame(0, 4, 0, 500));
            frame.Frames.Add(MirAction.Walking, new Frame(32, 6, 0, 100));
            ...
            Monsters.Add(frame = new FrameSet());
            frame.Frames.Add(MirAction.Standing, new Frame(0, 4, 6, 500));
            frame.Frames.Add(MirAction.Walking, new Frame(80, 8, 2, 100));
            frame.Frames.Add(MirAction.Attack1, new Frame(160, 8, 2, 100));
            frame.Frames.Add(MirAction.Struck, new Frame(240, 2, 0, 200));
            frame.Frames.Add(MirAction.Die, new Frame(256, 10, 0, 100));
            frame.Frames.Add(MirAction.Dead, new Frame(265, 1, 9, 1000));
            ...
            frame.Frames.Add(MirAction.Walking, new Frame(80, 6, 4, 100));
            frame.Frames.Add(MirAction.Attack1, new Frame(160, 6, 4, 100));
            frame.Frames.Add(MirAction.Struck, new Frame(240, 4, 0, 200));
            frame.Frames.Add(MirAction.Die, new Frame(256, 10, 0, 100));
            frame.Frames.Add(MirAction.Dead, new Frame(265, 1, 9, 1000));
            //242 - 530
            Monsters.Add(frame = new FrameSet());
            frame.Frames.Add(MirAction.Standing, new Frame(0, 10, 0, 500));
            frame.Frames.Add(MirAction.Die, new Frame(10, 10, 0, 100));
            frame.Frames.Add(MirAction.Dead, new Frame(18, 1, 0, 1000));
            //243 - 533
            Monsters.Add(frame = new FrameSet());
            frame.Frames.Add(MirAction.Standing, new Frame(0, 4, 0, 500));
            frame.Frames.Add(MirAction.Walking, new Frame(32, 10, 0, 100));
            frame.Frames.Add(MirAction.Attack1, new Frame(96, 8, 0, 100));
            frame.Frames.Add(MirAction.Attack2, new Frame(264, 5, 0, 100));
            frame.Frames.Add(MirAction.Struck, new Frame(160, 3, 0, 200));
            frame.Frames.Add(MirAction.Die, new Frame(184, 10, 0, 100));
            frame.Frames.Add(MirAction.Dead, new Frame(193, 1, 9, 1000));
            //244 - 534
            Monsters.Add(frame = new FrameSet());
            frame.Frames.Add(MirAction.Standing, new Frame(0, 4, 0, 500));
            frame.Frames.Add(MirAction.Walking, new Frame(32, 7, 0, 100));
            frame.Frames.Add(MirAction.Attack1, new Frame(96, 8, 0, 100));
            frame.Frames.Add(MirAction.Attack2, new Frame(160, 8, 0, 100));
            frame.Frames.Add(MirAction.Struck, new Frame(224, 3, 0, 200));
            frame.Frames.Add(MirAction.Die, new Frame(248, 10, 0, 100));
            frame.Frames.Add(MirAction.Dead, new Frame(257, 1, 9, 1000));
            //245 - 536
            Monsters.Add(frame = new FrameSet());
            frame.Frames.Add(MirAction.Standing, new Frame(0, 4, 0, 500));
            frame.Frames.Add(MirAction.Walking, new Frame(32, 6, 0, 100));
            frame.Frames.Add(MirAction.Attack1, new Frame(80, 6, 0, 100));
            frame.Frames.Add(MirAction.Attack2, new Frame(232, 10, 0, 100));
            frame.Frames.Add(MirAction.Struck, new Frame(128, 4, 0, 200));
            ...
            frame.Frames.Add(MirAction.Attack1, new Frame(96, 10, 0, 100));
            frame.Frames.Add(MirAction.Attack2, new Frame(288, 10, 0, 100));
            frame.Frames.Add(MirAction.Struck, new Frame(176, 4, 0, 200));
            frame.Frames.Add(MirAction.Die, new Frame(208, 10, 0, 100));
            frame.Frames.Add(MirAction.Dead, new Frame(217, 1, 9, 1000));
            //247 - 538
            Monsters.Add(frame = new FrameSet());
            ...
            Monsters.Add(frame = new FrameSet());
            frame.Frames.Add(MirAction.Standing, new Frame(0, 1, 0, 500));
            frame.Frames.Add(MirAction.Attack1, new Frame(8, 10, 0, 100));
            frame.Frames.Add(MirAction.Struck, new Frame(88, 2, 0, 200));
            frame.Frames.Add(MirAction.Die, new Frame(104, 10, 0, 100));
            frame.Frames.Add(MirAction.Dead, new Frame(113, 1, 9, 1000));
            //249 - 546
            Monsters.Add(frame = new FrameSet());
            frame.Frames.Add(MirAction.Standing, new Frame(0, 10, 0, 500));
            frame.Frames.Add(MirAction.Walking, new Frame(80, 10, 0, 100));
            frame.Frames.Add(MirAction.Attack1, new Frame(160, 10, 0, 100));
            frame.Frames.Add(MirAction.Struck, new Frame(240, 4, 0, 200));
            frame.Frames.Add(MirAction.Die, new Frame(272, 10, 0, 100));
            frame.Frames.Add(MirAction.Dead, new Frame(281, 1, 9, 1000));
            //250 - 548
            Monsters.Add(frame = new FrameSet());
            frame.Frames.Add(MirAction.Appear, new Frame(272, 9, 0, 100));
            frame.Frames.Add(MirAction.Standing, new Frame(0, 4, 0, 500));
            frame.Frames.Add(MirAction.Walking, new Frame(32, 6, 0, 100));
            frame.Frames.Add(MirAction.Attack1, new Frame(80, 6, 0, 100));
            frame.Frames.Add(MirAction.Attack2, new Frame(128, 6, 0, 200));
            frame.Frames.Add(MirAction.Struck, new Frame(176, 2, 0, 200));
            frame.Frames.Add(MirAction.Die, new Frame(200, 9, 0, 100));
            frame.Frames.Add(MirAction.Dead, new Frame(208, 1, 8, 1000));
            //251 - 549
            Monsters.Add(frame = new FrameSet());
            frame.Frames.Add(MirAction.Standing, new Frame(0, 4, 0, 500));
            frame.Frames.Add(MirAction.Walking, new Frame(32, 6, 0, 100));
            frame.Frames.Add(MirAction.Attack1, new Frame(80, 10, 0, 100));
            frame.Frames.Add(MirAction.Attack2, new Frame(256, 10, 0, 200));
            frame.Frames.Add(MirAction.Struck, new Frame(160, 2, 0, 200));
            frame.Frames.Add(MirAction.Die, new Frame(174, 10, 0, 100));
            frame.Frames.Add(MirAction.Dead, new Frame(185, 1, 9, 1000));
            //252 - 554
            Monsters.Add(frame = new FrameSet());
            frame.Frames.Add(MirAction.Appear, new Frame(272, 10, 0, 100));
            frame.Frames.Add(MirAction.Standing, new Frame(0, 4, 0, 500));
            frame.Frames.Add(MirAction.Walking, new Frame(32, 6, 0, 100));
            frame.Frames.Add(MirAction.Attack1, new Frame(80, 6, 0, 100));
            frame.Frames.Add(MirAction.Attack2, new Frame(224, 6, 0, 100));
            ...
            frame.Frames.Add(MirAction.Attack1, new Frame(96, 8, 0, 100));
            frame.Frames.Add(MirAction.Attack2, new Frame(160, 9, 0, 100));
            frame.Frames.Add(MirAction.Attack3, new Frame(232, 7, 0, 100));
            frame.Frames.Add(MirAction.Struck, new Frame(288, 3, 0, 200));
            frame.Frames.Add(MirAction.Die, new Frame(312, 10, 0, 100));
            frame.Frames.Add(MirAction.Dead, new Frame(321, 1, 9, 1000));
            //255 - 568 (Jin Lord)
            ...
            frame.Frames.Add(MirAction.Walking, new Frame(32, 6, 0, 100));
            frame.Frames.Add(MirAction.Attack1, new Frame(80, 9, 0, 100));
            frame.Frames.Add(MirAction.Attack2, new Frame(248, 9, 0, 100));
            frame.Frames.Add(MirAction.Attack3, new Frame(320, 8, 0, 100));
            frame.Frames.Add(MirAction.Struck, new Frame(152, 2, 0, 200));
            frame.Frames.Add(MirAction.Die, new Frame(168, 10, 0, 100));
            frame.Frames.Add(MirAction.Dead, new Frame(177, 1, 9, 1000));
            //256 - 569
            Monsters.Add(frame = new FrameSet());
            ...
            frame.Frames.Add(MirAction.Attack1, new Frame(80, 9, 0, 100));
            frame.Frames.Add(MirAction.Attack2, new Frame(248, 9, 0, 100));
            frame.Frames.Add(MirAction.Attack3, new Frame(320, 9, 0, 100));
            frame.Frames.Add(MirAction.Struck, new Frame(152, 2, 0, 200));
            frame.Frames.Add(MirAction.Die, new Frame(168, 10, 0, 100));
            frame.Frames.Add(MirAction.Dead, new Frame(177, 1, 9, 1000));
            //257 - 573
            ...
            frame.Frames.Add(MirAction.Walking, new Frame(32, 6, 0, 100));
            frame.Frames.Add(MirAction.Attack1, new Frame(160, 10, 0, 100));
            frame.Frames.Add(MirAction.Struck, new Frame(80, 2, 0, 200));
            frame.Frames.Add(MirAction.Die, new Frame(96, 10, 0, 100));
            frame.Frames.Add(MirAction.Dead, new Frame(105, 1, 9, 1000));
            //259 - 576
            Monsters.Add(frame = new FrameSet());
            frame.Frames.Add(MirAction.Standing, new Frame(0, 6, 0, 500));
            frame.Frames.Add(MirAction.Die, new Frame(5, 10, 0, 100));
            frame.Frames.Add(MirAction.Dead, new Frame(15, 1, 0, 1000));
            //260 - 583 tan
            Monsters.Add(frame = new FrameSet());
            frame.Frames.Add(MirAction.Standing, new Frame(0, 4, 0, 500));
            frame.Frames.Add(MirAction.Walking, new Frame(32, 6, 0, 100));
            frame.Frames.Add(MirAction.Attack1, new Frame(80, 8, 0, 100));
            frame.Frames.Add(MirAction.Attack2, new Frame(232, 8, 0, 100));
            frame.Frames.Add(MirAction.Attack3, new Frame(296, 8, 0, 100));
            frame.Frames.Add(MirAction.Struck, new Frame(144, 2, 0, 200));
            frame.Frames.Add(MirAction.Die, new Frame(160, 9, 0, 100));
            frame.Frames.Add(MirAction.Dead, new Frame(168, 1, 8, 1000));
            //261 - 594
            ...
            frame.Frames.Add(MirAction.Walking, new Frame(32, 6, 0, 100));
            frame.Frames.Add(MirAction.Attack1, new Frame(80, 10, 0, 100));
            frame.Frames.Add(MirAction.Attack2, new Frame(272, 8, 0, 100));
            frame.Frames.Add(MirAction.Attack3, new Frame(336, 10, 0, 100));
            frame.Frames.Add(MirAction.Struck, new Frame(160, 4, 0, 200));
            frame.Frames.Add(MirAction.Die, new Frame(192, 10, 0, 100));
            frame.Frames.Add(MirAction.Dead, new Frame(201, 1, 9, 1000));
            //262 - 597
            Monsters.Add(frame = new FrameSet());
            frame.Frames.Add(MirAction.Standing, new Frame(0, 6, 0, 500));
            frame.Frames.Add(MirAction.Walking, new Frame(48, 8, 0, 100));
            frame.Frames.Add(MirAction.Attack1, new Frame(112, 6, 0, 100));
            frame.Frames.Add(MirAction.Attack2, new Frame(232, 9, 0, 100));
            frame.Frames.Add(MirAction.Attack3, new Frame(304, 15, 0, 100));
            frame.Frames.Add(MirAction.Struck, new Frame(128, 2, 0, 200));
            frame.Frames.Add(MirAction.Die, new Frame(320, 10, 0, 100));
            frame.Frames.Add(MirAction.Dead, new Frame(329, 1, 0, 1000));
            //263 - 606
            Monsters.Add(frame = new FrameSet());
            frame.Frames.Add(MirAction.Standing, new Frame(0, 10, 0, 500));
            frame.Frames.Add(MirAction.Walking, new Frame(80, 6, 0, 100));
            frame.Frames.Add(MirAction.Attack1, new Frame(128, 8, 0, 100));
            frame.Frames.Add(MirAction.Attack2, new Frame(256, 8, 0, 100));
            frame.Frames.Add(MirAction.Struck, new Frame(192, 2, 0, 200));
            frame.Frames.Add(MirAction.Die, new Frame(208, 6, 0, 100));
            frame.Frames.Add(MirAction.Dead, new Frame(213, 1, 5, 1000));
            //264 - 607
            Monsters.Add(frame = new FrameSet());
            frame.Frames.Add(MirAction.Standing, new Frame(0, 10, 0, 500));
            frame.Frames.Add(MirAction.Walking, new Frame(80, 10, 0, 100));
            frame.Frames.Add(MirAction.Attack1, new Frame(160, 10, 0, 100));
            frame.Frames.Add(MirAction.Struck, new Frame(240, 4, 0, 200));
            frame.Frames.Add(MirAction.Die, new Frame(272, 8, 0, 100));
            frame.Frames.Add(MirAction.Dead, new Frame(279, 1, 7, 1000));
            //265 - 608
            Monsters.Add(frame = new FrameSet());
            frame.Frames.Add(MirAction.Standing, new Frame(0, 10, 0, 500));
            frame.Frames.Add(MirAction.Walking, new Frame(80, 10, 0, 100));
            frame.Frames.Add(MirAction.Attack1, new Frame(160, 10, 0, 100));
            frame.Frames.Add(MirAction.Struck, new Frame(240, 3, 0, 200));
            frame.Frames.Add(MirAction.Die, new Frame(264, 8, 0, 100));
            frame.Frames.Add(MirAction.Dead, new Frame(271, 1, 7, 1000));
            //266 - 609
            Monsters.Add(frame = new FrameSet());
            frame.Frames.Add(MirAction.Standing, new Frame(0, 6, 0, 500));
            frame.Frames.Add(MirAction.Walking, new Frame(48, 6, 0, 100));
            ...
            frame.Frames.Add(MirAction.Walking, new Frame(80, 10, 0, 100));
            frame.Frames.Add(MirAction.Attack1, new Frame(160, 10, 0, 100));
            frame.Frames.Add(MirAction.Attack2, new Frame(352, 10, 0, 100));
            frame.Frames.Add(MirAction.Struck, new Frame(240, 4, 0, 200));
            frame.Frames.Add(MirAction.Die, new Frame(272, 10, 0, 100));
            frame.Frames.Add(MirAction.Dead, new Frame(281, 1, 9, 1000));
            //269 - 616
    ...
    public class Frame
    {
        public int BaseStart, BaseCount, BaseSkip, BaseInterval;
        ...
        {
            get { return BaseCount + BaseSkip; }
        }

        public Frame(int start, int count, int skip, int interval, int effectstart = 0, int effectcount = 0, int effectskip = 0, int effectinterval = 0, int basestart = 0, int basecount = 0, int baseskip = 0, int baseinterval = 0)
        {
            Start = start;
            Count = count;
            Skip = skip;
