...
namespace Client.MirScenes.Dialogs
{
    ...
    public sealed class NPCDropDialog : MirImageControl
    {
        ...
        public void Confirm()
        {
            ...
            switch (PType)
            {
                ...
                case PanelType.Consign:
                    ...
                    MirAmountBoxDual box = new MirAmountBoxDual("Consignment Price:", TargetItem.Image, Globals.MaxConsignment, Globals.MinConsignment)
                    {
                    ...
                    {
                        Network.Enqueue(new C.ConsignItem { UniqueID = TargetItem.UniqueID, Price = box.Amount , GGPrice = box.Amount2 });
                        TargetItem = null;
                    };
                    return;
        ...
        private void ItemCell_Click()
        {
            ...
            {
                if (GameScene.SelectedCell.Item.Awake.AwakeLevel!= 0)
                {
                    TargetItem = GameScene.SelectedCell.Item;
                    OldCell = GameScene.SelectedCell;
                    OldCell.Locked = true;
