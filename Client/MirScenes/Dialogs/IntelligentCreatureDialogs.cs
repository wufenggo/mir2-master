...
namespace Client.MirScenes.Dialogs
{
    public sealed class IntelligentCreatureDialog : MirImageControl
    {
        ...
        public MirButton AutomaticModeButtonOn, AutomaticModeButtonOff, SemiAutoModeButton, OptionsMenuButton;
        ...
        public IntelligentCreatureDialog()
        {
            ...
            MirLabel label = new MirLabel
            {
                ...
                Parent = this,
                Text = "Automatic Mode",
                Font = new Font(Settings.FontName, 6f, FontStyle.Regular),
                ForeColour = Color.Goldenrod,
                DrawFormat = TextFormatFlags.WordBreak
            };
            AutomaticModeButtonOn = new MirButton//image is wrongly translated should be "Auto" instaid of "Enable"
            {
                HoverIndex = 457,
                Index = Automatic == true ? 458 : 456,
                Location = new Point(375, label.Location.Y + label.Size.Height + 4),
                Library = Libraries.Prguse2,
                Parent = this,
                PressedIndex = 457,
                Sound = SoundList.ButtonA,
            };
            AutomaticModeButtonOn.Click += (o, e) =>
            {
                ...
                AutomaticModeButtonOn.Index = 458;
                AutomaticModeButtonOff.Index = 459;
                ...
                Network.Enqueue(new C.UpdateIntelligentCreature { Creature = GameScene.User.IntelligentCreatures[selectedCreature], SummonMe = false, UnSummonMe = false, ReleaseMe = false });
            };

            AutomaticModeButtonOff = new MirButton//image is wrongly translated should be "Auto" instaid of "Enable"
            {
                HoverIndex = 460,
                Index = Automatic == true ? 459 : 461,
                Location = new Point(375, AutomaticModeButtonOn.Location.Y + AutomaticModeButtonOn.Size.Height + 3),
                Library = Libraries.Prguse2,
                Parent = this,
                PressedIndex = 460,
                Sound = SoundList.ButtonA,
            };
            AutomaticModeButtonOff.Click += (o, e) =>
            {
                int selectedCreature = BeforeAfterDraw();
                if (selectedCreature < 0) return;
                ...
                AutomaticModeButtonOn.Index = 456;
                AutomaticModeButtonOff.Index = 461;
        ...
        private void RefreshUI()
        {
            ...
            if (error)
            {
                ...
                AutomaticModeButtonOn.Enabled = false;
                AutomaticModeButtonOff.Enabled = false;
            ...
            else
            {
                ...
                AutomaticModeButtonOn.Enabled = true;
                AutomaticModeButtonOff.Enabled = true;
