...
namespace Client.MirScenes.Dialogs
{
    ...
    public sealed class GuildDialog : MirImageControl
    {
        ...
        #region GuildAbitly
        public MirButton GuildAbitlyButton;
        #endregion
        ...
        public GuildDialog()
        {
            ...
            //GuildAbitlyButton = new MirButton
            //{
            //    Library = Libraries.CustomPrguse,
            //    Index = 266,
            //    PressedIndex = 265,
            ...
            //};
            //GuildAbitlyButton.Click += (o, e) =>
            //{
            //    if (GameScene.Scene.BounsDialog.Visible)
            //        GameScene.Scene.BounsDialog.Hide();
            //    else
            //        GameScene.Scene.BounsDialog.Show();
            //};
        ...
        public void NewRankRecieved(Rank New)
        {
            ...
            if (Ranks != null && Ranks.Count > 1 &&
                NewIndex > Ranks.Count - 1)
                return;
