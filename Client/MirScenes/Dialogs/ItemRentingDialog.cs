...
namespace Client.MirScenes.Dialogs
{
    public sealed class ItemRentingDialog : MirImageControl
    {
        ...
        {
            var inputBox = new MirInputBox($"你想租多久 {RentalItem.Name} to {GameScene.Scene.GuestItemRentDialog.GuestName} for? (1 to 30 days).");
        ...
        public void RefreshInterface()
        {
            ...
            _rentalPeriodLabel.Text = $"租赁日期: {RentalPeriod} 天";
    ...
    public sealed class GuestItemRentingDialog : MirImageControl
    {
        ...
        public void RefreshInterface()
        {
            ...
            _rentalPeriodLabel.Text = $"租赁日期: {GuestRentalPeriod} 天";
