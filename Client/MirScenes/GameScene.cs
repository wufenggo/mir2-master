        ...
        public override string ToString()
        {
            ...
            switch (Type)
            {
                ...
                case BuffType.Taoist:
                    ...
                    break;
                case BuffType.Storm:
                    text = string.Format("突袭\n增加 A.Speed by: {0}.\n", Values[0]);
                    break;
                case BuffType.HealthAid:
                    text = string.Format("生命之力\nIncreases HP by: {0}.\n", Values[0]);
                    break;
                case BuffType.ManaAid:
                    text = string.Format("魔法之力\nIncreases MP by: {0}.\n", Values[0]);
                    break;
                ...
                case BuffType.WonderDrug:
                    ...
                    {
                        case 0:
                            text += string.Format("增加经验率 by {0}%\n", Values[1]);
                            break;
                        case 1:
                            text += string.Format("增加爆率 by {0}%\n", Values[1]);
                            break;
                        case 2:
                            text += string.Format("增加生命值 by: {0}.\n", Values[1]);
                            break;
                        case 3:
                            text += string.Format("增加魔力值 by: {0}.\n", Values[1]);
                            break;
                        case 4:
                            text += string.Format("增加最大防御 by: {0}-{0}.\n", Values[1]);
                            break;
                        case 5:
                            text += string.Format("增加最大魔域 by: {0}-{0}.\n", Values[1]);
                            break;
                        case 6:
                            text += string.Format("增加攻击速度 by: {0}.\n", Values[1]);
                            break;
                    }
                    break;
